(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([[6898], {
    78840: function (t, e, i) {
        ...
        r = "undefined" != typeof window ? window : this, o = function (t) {
            ...
            return i(e, "Core/Globals.js", [], function () {
                ...
                let e, i, s;
                let {charts: r, doc: o, win: n} = t;

                function a(e, i, s, r) {
                    let o = i ? "Highcharts error" : "Highcharts warning";
                    32 === e && (e = `${o}: Deprecated member`);
                    let l = g(e), h = l ? `${o} #${e}: www.highcharts.com/errors/${e}/` : e.toString();
                    if (void 0 !== r) {
                        let t = "";
 ...
 - ${i}: ${e}`, l && (h += encodeURI(i) + "=" + encodeURI(e))
                ...
                M({map: "map", each: "forEach", grep: "filter", reduce: "reduce", some: "some"}, function (e, i) {
                    t[i] = function (t) {
                        return a(32, !1, void 0, {[`Highcharts.${i}`]: `use Array.${e}`}), Array.prototype[e].apply(t, [].slice.call(arguments, 1))
                    }
                });
                ...
                return n.jQuery && (n.jQuery.fn.highcharts = function () {
                    ...
                    addEvent: function (e, i, s, r = {}) {
                        ...
                        return n[i].push(l), n[i].sort((t, e) => t.order - e.order), function () {
                            w(e, i, s)
                        }
                    },
                    arrayMax: function (t) {
                    ...
                    getClosestDistance: function (t, e) {
                        ...
                        let o = !e;
                        return t.forEach(t => {
                            if (t.length > 1) for (r = t.length - 1; r > 0; r--) (s = t[r] - t[r - 1]) < 0 && !o ? (e?.(), e = void 0) : s && (void 0 === i || s < i) && (i = s)
                        }), i
                    },
                    getMagnitude: k,
                    ...
                    insertItem: function (t, e) {
                        let i;
                        let s = t.options.index, r = e.length;
                        for (i = t.options.isInternal ? r : 0; i < r + 1; i++) if (!e[i] || g(s) && s < b(e[i].options.index, e[i]._i) || e[i].options.isInternal) {
                            e.splice(i, 0, t);
                            break
                        }
                        return i
                    ...
                    objectEach: M,
                    offset: function (t) {
                        let e = o.documentElement, i = t.parentElement || t.parentNode ? t.getBoundingClientRect() : {
                            top: 0,
                            left: 0,
                            width: 0,
                            height: 0
                ...
                class m {
                    ...
                    set(t, e, i) {
                        if (this.variableTimezone || this.timezoneOffset) {
                            ...
                            let s = this.getTimezoneOffset(e), r = e.getTime() - s;
                    ...
                    timezoneOffsetFunction() {
                        ...
                        return this.useUTC ? e.timezone ? t => {
                            try {
                                let i = `shortOffset,${e.timezone || ""}`, [s, r, o, a, l = 0] = (m.formatCache[i] = m.formatCache[i] || Intl.DateTimeFormat("en", {
                                    timeZone: e.timezone,
                                    timeZoneName: "shortOffset"
                                })).format(t).split(/(GMT|:)/).map(Number), h = -(36e5 * (o + l / 60));
                                if (n(h)) return h
                            } catch (t) {
                                r(34)
                            }
                    ...
                    dateFormat(e, i, r) {
                        ...
                        e = c(e, "%Y-%m-%d %H:%M:%S");
                        let n = this, a = new this.Date(i), l = this.get("Hours", a), p = this.get("Day", a),
                    ...
                    getTimeTicks(t, e, i, r) {
                        ...
                        if (r = c(r, 1), s(e)) {
                            ...
                            let t = d.get("Month", m), o = d.get("Date", m), c = d.get("Hours", m);
                    ...
                    getDateFormat(t, e, i, s) {
                        let r = this.dateFormat("%m-%d %H:%M:%S.%L", e), o = "01-01 00:00:00.000",
                            n = {millisecond: 15, second: 12, minute: 9, hour: 6, day: 3}, a = "millisecond", l = a;
                        for (a in u) {
                ...
                let {isTouchDevice: o} = e, {fireEvent: n, merge: a} = r, l = {
                    colors: i.colors,
                ...
                return {
                    defaultOptions: l, defaultTime: h, getOptions: function () {
                        ...
                        return n(e, "setOptions", {options: t}), a(!0, l, t), (t.time || t.global) && (e.time ? e.time.update(a(l.global, l.time, t.global, t.time)) : e.time = h), l
                    }
                }
                ...
                let {parse: s} = t, {win: r} = e, {isNumber: o, objectEach: n} = i;
                ...
                class a {
                    ...
                    run(t, e, i) {
                        let s = this, o = s.options, n = function (t) {
                    ...
                    step(t) {
                        let e, i;
                        let s = +new Date, r = this.options, o = this.elem, a = r.complete, l = r.duration,
                            h = r.curAnim;
                    ...
                    initPath(t, e, i) {
                        let s = t.startX, r = t.endX, n = i.slice(), a = t.isArea, l = a ? 2 : 1,
                        ...
                        return g.length && o(d) && (c = n.length + d * l, u ? (f(g, n), m(n)) : (f(n, g), m(g))), [g, n]
                    }
                ...
                let {SVG_NS: i, win: s} = t, {
                    ...
                    u = p && l(p.createPolicy) && p.createPolicy("highcharts", {createHTML: t => t}),
                ...
                class m {
                    static filterUserAttributes(t) {
                        return d(t, (e, i) => {
                            let s = !0;
                            -1 === m.allowedAttributes.indexOf(i) && (s = !1), -1 !== ["background", "dynsrc", "href", "lowsrc", "src"].indexOf(i) && (s = h(e) && m.allowedReferences.some(t => 0 === e.indexOf(t))), s || (a(33, !1, void 0, {"Invalid attribute in config": `${i}`}), delete t[i]), h(e) && t[i] && (t[i] = e.replace(/</g, "&lt;"))
                        }), t
                    }
                            ...
                            return c(s).forEach(function (s) {
                                ...
                                if (c) {
                                    if ("#text" === c) h = p; else if (-1 !== m.allowedTags.indexOf(c) || u) {
                                        let a = "svg" === c ? i : o.namespaceURI || i, l = t.doc.createElementNS(a, c),
                                            g = s.attributes || {};
                                        d(s, function (t, e) {
                    ...
                    parseMarkup(t) {
                        ...
                        let s = (t, e) => {
                            let i = t.nodeName.toLowerCase(), r = {tagName: i};
                ...
                let {defaultOptions: i, defaultTime: s} = t, {
                    ...
                    each: function (t) {
                        ...
                        return !!n(t) && t.map((i, s) => p(e.body, r(l(i) ? i : {"@this": i}, {
                            "@index": s,
                            "@first": 0 === s,
                            "@last": s === t.length - 1
                        }))).join("")
                ...
                function p(t = "", e, r) {
                    let n = /\{([\w\:\.\,;\-\/<>%@"'’= #\(\)]+)\}/g, a = /\(([\w\:\.\,;\-\/<>%@"'= ]+)\)/g, l = [],
                        d = /f$/, g = /\.(\d)/, f = i.lang, m = r && r.time || s, x = r && r.numberFormatter || u,
                        y = (t = "") => {
                            let i;
                    ...
                    return l.forEach(i => {
                        let s, o;
                        let {body: n, elseBody: a, expression: l, fn: u} = i;
                        if (u) {
                            let t = [i], h = l.split(" ");
                ...
                function u(t, e, s, r) {
                    let o, n;
                    t = +t || 0, e = +e;
                    let l = i.lang, c = (t.toString().split(".")[1] || "").split("e")[0].length,
                        p = t.toString().split("e"), u = e;
                    ...
                    let g = (Math.abs(p[1] ? p[0] : t) + Math.pow(10, -Math.max(e, c) - 1)).toFixed(e),
                        f = String(d(g)), m = f.length > 3 ? f.length % 3 : 0;
                ...
                return (e || (e = {})).distribute = function t(e, n, a) {
                    let l = e, h = l.reducedLen || n, d = (t, e) => t.target - e.target, c = [], p = e.length, u = [],
                        g = c.push, f, m, x, y = !0, b, v, k = 0, S;
                    ...
                    for (o(e, d), e = e.map(t => ({size: t.size, targets: [t.target], align: s(t.align, .5)})); y;) {
                ...
                class j {
                    ...
                    animate(t, e, i) {
                        let s = o(T(e, this.renderer.globalAnimation, !0)), n = s.defer;
                    ...
                    applyTextOutline(t) {
                        ...
                        let s = t.split(" "), r = s[s.length - 1], o = s[0];
                        if (o && "none" !== o && i.svg) {
                    ...
                    attr(t, e, i, s) {
                        let {element: r} = this, o = j.symbolCustomAttribs, a, l, h = this, d;
                    ...
                    crisp(t, e) {
                        ...
                        let i = t.x || this.x || 0, s = t.y || this.y || 0, r = (t.width || this.width || 0) + i,
                            o = (t.height || this.height || 0) + s, n = f(i, e), a = f(s, e);
                        return b(t, {
                            x: n,
                            y: a,
                            width: f(r, e) - n,
                    ...
                    complexColor(t, i, s) {
                        let r = this.renderer, o, n, a, l, h, d, c, p, u, g, f = [], m;
                        v(this.renderer, "complexColor", {args: arguments}, function () {
                            if (t.radialGradient ? n = "radialGradient" : t.linearGradient && (n = "linearGradient"), n) {
                                ...
                                }), "radialGradient" === n && u && !x(a.gradientUnits) && (l = a, a = w(a, r.getRadialAttr(u, l), {gradientUnits: "userSpaceOnUse"})), A(a, function (t, e) {
                                    "id" !== e && f.push(e, t)
                                }), A(d, function (t) {
                                    f.push(t)
                    ...
                    destroy() {
                        let t = this, e = t.element || {}, i = t.renderer, s = e.ownerSVGElement,
                            r = "SPAN" === e.nodeName && t.parentGroup || void 0, o, a;
                    ...
                    getBBox(t, e) {
                        let i, s, r, o;
                        let {alignValue: n, element: a, renderer: l, styles: h, textStr: d} = this, {
                                cache: c,
                                cacheKeys: p
                            } = l, u = a.namespaceURI === this.SVG_NS, g = T(e, this.rotation, 0),
                            f = l.styledMode ? a && j.prototype.getStyle.call(a, "font-size") : h.fontSize;
                        if (x(d) && (-1 === (o = d.toString()).indexOf("<") && (o = o.replace(/\d/g, "0")), o += ["", l.rootFontSize, f, g, this.textWidth, n, h.textOverflow, h.fontWeight].join(",")), o && !t && (i = c[o]), !i || i.polygon) {
                            if (u || l.forExport) {
                                try {
                    ...
                    getRotatedBox(t, e) {
                        let {x: i, y: s, width: r, height: o} = t, {
                                ...
                                rotationOriginX: h = 0,
                                rotationOriginY: d = 0
                            } = this, c = {right: 1, center: .5}[n || 0] || 0,
                            p = Number(this.element.getAttribute("y") || 0) - (l ? 0 : s), u = e * a, g = (e - 90) * a,
                            f = Math.cos(u), m = Math.sin(u), x = r * f, y = r * m, b = Math.cos(g),
                            v = Math.sin(g), [[k, S], [C, M]] = [h, d].map(t => [t - t * f, t * m]),
                            w = i + c * (r - x) + k + M + p * b, A = w + x, T = A - o * b, P = T - x,
                            L = s + p - c * y - S + C + p * v, O = L + y, E = O - o * v, D = E - y,
                            j = Math.min(w, A, T, P), I = Math.min(L, O, E, D), B = Math.max(w, A, T, P) - j,
                            R = Math.max(L, O, E, D) - I;
                        return {x: j, y: I, width: B, height: R, polygon: [[w, L], [A, O], [T, E], [P, D]]}
                    }
                    ...
                    shadow(t) {
                        let {renderer: e} = this,
                            i = w(this.parentGroup?.rotation === 90 ? {offsetX: -1, offsetY: -1} : {}, C(t) ? t : {}),
                    ...
                    updateTransform(t = "transform") {
                        ...
                        x(i) && d.push("matrix(" + i.join(",") + ")"), s && (d.push("rotate(" + s + " " + T(r, e.getAttribute("x"), 0) + " " + T(o, e.getAttribute("y") || 0) + ")"), "SPAN" === this.text?.element.tagName && this.text.attr({
                            rotation: s,
                    ...
                    zIndexSetter(t, e) {
                        let i = this.renderer, s = this.parentGroup, r = (s || i).element || i.box, o = this.element,
                            n = r === i.box, a, l, h, d = !1, c, p = this.added, u;
                ...
                class l extends t {
                    ...
                    getBBox(t, e) {
                        ...
                        let {padding: i, height: s = 0, translateX: r = 0, translateY: o = 0, width: a = 0} = this,
                            l = n(this.paddingLeft, i), h = e ?? (this.rotation || 0), d = {
                                width: a,
                                height: s,
                                x: r + this.bBox.x - l,
                    ...
                    updateBoxSize() {
                        let t;
                        let e = this.text, o = {}, n = this.padding,
                ...
                function r(t, i, r, o, n) {
                    let a = [];
                    if (n) {
                        let l = n.start || 0, h = s(n.r, r), d = s(n.r, o || r),
                            c = 2e-4 / (n.borderRadius ? 1 : Math.max(h, 1)),
                            p = Math.abs((n.end || 0) - l - 2 * Math.PI) < c, u = (n.end || 0) - (p ? c : 0),
                            g = n.innerR, f = s(n.open, p), m = Math.cos(l), x = Math.sin(l), y = Math.cos(u),
                            b = Math.sin(u), v = s(n.longArc, u - l - Math.PI < c ? 0 : 1),
                ...
                return {
                    arc: r, callout: function (t, e, s, r, o) {
                        let a = Math.min(o && o.r || 0, s, r), l = a + 6, h = o && o.anchorX, d = o && o.anchorY || 0,
                            c = n(t, e, s, r, {r: a});
                        if (!i(h) || h < s && h > 0 && d < r && d > 0) return c;
                        if (t + h > s - l) {
                            if (d > e + l && d < e + r - l) c.splice(3, 1, ["L", t + s, d - 6], ["L", t + s + 6, d], ["L", t + s, d + 6], ["L", t + s, e + r - a]); else if (h < s) {
                                let i = d < e + l;
                                c.splice(i ? 2 : 5, 0, ["L", h, d], ["L", t + s - a, i ? e : e + r])
                            } else c.splice(3, 1, ["L", t + s, r / 2], ["L", h, d], ["L", t + s, r / 2], ["L", t + s, e + r - a])
                        } else if (t + h < l) {
                            if (d > e + l && d < e + r - l) c.splice(7, 1, ["L", t, d + 6], ["L", t - 6, d], ["L", t, d - 6], ["L", t, e + a]); else if (h > 0) {
                                let i = d < e + l;
                                c.splice(i ? 1 : 6, 0, ["L", h, d], ["L", t + a, i ? e : e + r])
                    ...
                    }, rect: o, roundedRect: n, square: o, triangle: function (t, e, i, s) {
                ...
                return class {
                    ...
                    buildSVG() {
                        let e = this.svgElement, i = e.element, r = e.renderer, o = c(e.textStr, "").toString(),
                            n = -1 !== o.indexOf("<"), a = i.childNodes, l = !e.added && r.box,
                    ...
                    modifyDOM() {
                        ...
                        let l = (t, o) => {
                            let l = t.textContent || "", h = l.replace(/([^\^])-/g, "$1- ").split(" "),
                                ...
                                c = this.getLineHeight(o), p = 0, u = e.actualWidth;
                            if (this.ellipsis) l && this.truncate(t, l, void 0, 0, Math.max(0, a - .8 * c), (t, e) => t.substring(0, e) + "…"); else if (d) {
                                let l = [], d = [];
                                ...
                                d.forEach(e => {
                                    ...
                                    a.textContent = "​", n(a, {dy: c, x: i}), o.insertBefore(a, t)
                                })
                            }
                        }, h = t => {
                    ...
                    modifyTree(t) {
                        let e = (i, s) => {
                            let {attributes: r = {}, children: o, style: n = {}, tagName: l} = i,
                    ...
                    truncate(t, e, i, s, r, o) {
                        let n, a;
                        let l = this.svgElement, {rotation: h} = l, d = [], c = i ? 1 : 0, p = (e || i || "").length,
                            u = p, g = function (e, r) {
                                let o = r || e, n = t.parentNode;
                ...
                class W {
                    constructor(t, e, i, s, r, o, n) {
                        ...
                        let h = this.createElement("svg").attr({version: "1.1", class: "highcharts-root"}),
                            d = h.element;
                        n || h.css(this.getStyle(s || {})), t.appendChild(d), C(t, "dir", "ltr"), -1 === t.innerHTML.indexOf("xmlns") && C(d, "xmlns", this.SVG_NS), this.box = d, this.boxWrapper = h, this.alignedObjects = [], this.url = this.getReferenceURL(), this.createElement("desc").add().element.appendChild(g.createTextNode("Created with Highcharts 11.4.7")), this.defs = this.createElement("defs").add(), this.allowHTML = o, this.forExport = r, this.styledMode = n, this.gradients = {}, this.cache = {}, this.cacheKeys = [], this.imgCount = 0, this.rootFontSize = h.getStyle("font-size"), this.setSize(e, i, !1), f && t.getBoundingClientRect && ((a = function () {
                            A(t, {
                                left: 0,
                                top: 0
                    ...
                    shadowDefinition(t) {
                        let e = [`highcharts-drop-shadow-${this.chartIndex}`, ...Object.keys(t).map(e => `${e}-${t[e]}`)].join("-").toLowerCase().replace(/[^a-z\d\-]/g, ""),
                            i = I({color: "#000000", offsetX: 1, offsetY: 1, opacity: .15, width: 5}, t);
                    ...
                    button(e, i, s, r, o = {}, n, a, l, h, d) {
                        let p = this.label(e, i, s, h, void 0, void 0, d, void 0, "button"), u = this.styledMode,
                            g = arguments, f = 0;
                        o = I(c.global.buttonTheme, o), u && (delete o.fill, delete o.stroke, delete o["stroke-width"]);
                        let x = o.states || {}, y = o.style || {};
                        delete o.states, delete o.style;
                        let b = [t.filterUserAttributes(o)], v = [y];
                        ...
                        }, p.attr(b[0]), !u && (p.css(L({cursor: "default"}, y)), d && p.text.css({pointerEvents: "none"})), p.on("touchstart", t => t.stopPropagation()).on("click", function (t) {
                            3 !== f && r.call(p, t)
                        })
                    }
                    ...
                    circle(t, e, i) {
                        let s = D(t) ? t : void 0 === t ? {} : {x: t, y: e, r: i}, r = this.createElement("circle");
                    ...
                    image(t, e, i, s, r, o) {
                        ...
                        let a = this.createElement("image").attr(n), l = function (e) {
                    ...
                    text(t, e, i, s) {
                        ...
                        return s && (!this.forExport || this.allowHTML) || (o.xSetter = function (t, e, i) {
                            let s = i.getElementsByTagName("tspan"), r = i.getAttribute(e);
                    ...
                    fontMetrics(t) {
                        let e = R(o.prototype.getStyle.call(t, "font-size") || 0),
                            i = e < 24 ? e + 3 : Math.round(1.2 * e), s = Math.round(.8 * i);
                        return {h: i, b: s, f: e}
                    }
                ...
                let u = (t, e) => {
                    if (!t.div) {
                        let s = o(t.element, "class"), r = t.css, n = a("div", s ? {className: s} : void 0, {
                            position: "absolute",
                        ...
                        t.classSetter = (t, e, i) => {
                            ...
                            return i.prototype.on.apply({element: n, onEvents: t.onEvents}, arguments), t
                        }, t.div = n
                    }
                    return t.div
                };
                ...
                class g extends i {
                    ...
                    updateTransform() {
                        ...
                        if (n(t, {marginLeft: `${d}px`, marginTop: `${c}px`}), "SPAN" === t.tagName) {
                            let o = [i, a, t.innerHTML, h, this.textAlign].join(","),
                                d = -(this.parentGroup?.padding * 1) || 0, c, f = !1;
                            ...
                            n(t, {
                                left: `${p + m}px`,
                                top: `${u + x}px`,
                                transformOrigin: `${(s ?? p) - m - p - d}px ${(r ?? u) - x - u - d}px`
                            }), this.cTT = o, this.oldRotation = i, this.oldAlign = a
                        }
                    }

                    setSpanRotation(t, e, i) {
                        n(this.element, {transform: `rotate(${t}deg)`, transformOrigin: `${e}% ${i}px`})
                    }
                ...
                return (e || (e = {})).registerEventOptions = function (t, e) {
                    t.eventOptions = t.eventOptions || {}, r(e.events, function (e, r) {
                        t.eventOptions[r] !== e && (t.eventOptions[r] && (o(t, r, t.eventOptions[r]), delete t.eventOptions[r]), s(e) && (t.eventOptions[r] = e, i(t, r, e, {order: 0})))
                    })
                }, e
                ...
                return class {
                    ...
                    addLabel() {
                        let e = this, i = e.axis, s = i.options, r = i.chart, a = i.categories, c = i.logarithmic,
                            p = i.names, g = e.pos, f = u(e.options && e.options.labels, s.labels), m = i.tickPositions,
                            x = g === m[0], y = g === m[m.length - 1],
                            b = (!f.step || 1 === f.step) && 1 === i.tickInterval, v = m.info, k = e.label, S, C, M,
                        ...
                        let T = e => f.formatter ? f.formatter.call(e, e) : f.format ? (e.text = i.defaultLabelFormatter.call(e), t.format(f.format, e, r)) : i.defaultLabelFormatter.call(e),
                            P = T.call(A, A), L = C && C.list;
                        L ? e.shortenLabel = function () {
                            for (M = 0; M < L.length; M++) if (l(A, {dateTimeLabelFormat: L[M]}), k.attr({text: T.call(A, A)}), k.getBBox().width < i.getSlotWidth(e) - 2 * (f.padding || 0)) return;
                            k.attr({text: ""})
                        } : e.shortenLabel = void 0, b && i._addedPlotLB && e.moveLabel(P, f), n(k) || e.movedLabel ? k && k.textStr !== P && !b && (!k.textWidth || f.style.width || k.styles.width || k.css({width: null}), k.attr({text: P}), k.textPxLength = k.getBBox().width) : (e.label = k = e.createLabel(P, f), e.rotation = 0)
                    }

                    createLabel(t, e, i) {
                        let s = this.axis, r = s.chart,
                    ...
                    getPosition(t, e, i, s) {
                        let n = this.axis, a = n.chart, l = s && a.oldChartHeight || a.chartHeight, d = {
                    ...
                    getLabelPosition(t, e, i, r, o, a, l, d) {
                        ...
                        let g = this.axis, f = g.transA,
                            ...
                            v = o.distance, k = {};
                        return c = 0 === g.side ? i.rotation ? -v : -i.getBBox().height : 2 === g.side ? y.y + v : Math.cos(i.rotation * s) * (y.y - i.getBBox(!1, 0).height / 2), n(o.y) && (c = 0 === g.side && g.horiz ? o.y + c : o.y), t = t + u(o.x, [0, 1, 0, -1][g.side] * v) + b + y.x - (a && r ? a * f * (m ? -1 : 1) : 0), e = e + c - (a && !r ? a * f * (m ? 1 : -1) : 0), x && (p = l / (d || 1) % x, g.opposite && (p = x - p - 1), e += p * (g.labelOffset / x)), k.x = t, k.y = Math.round(e), h(this, "afterGetLabelPosition", {
                            pos: k,
                            tickmarkOffset: a,
                            index: l
                        }), k
                    ...
                    handleOverflow(t) {
                        let e = this.axis, i = e.options.labels, r = t.x, o = e.chart.chartWidth, n = e.chart.spacing,
                            a = u(e.labelLeft, Math.min(e.pos, n[3])),
                            l = u(e.labelRight, Math.max(e.isRadial ? 0 : e.pos + e.len, o - n[1])), h = this.label,
                            d = this.rotation, c = {left: 0, center: .5, right: 1}[e.labelAlign || h.attr("align")],
                            p = h.getBBox().width, g = e.getSlotWidth(this), f = {}, m = g, x = 1, y;
                        d || "justify" !== i.overflow ? d < 0 && r - c * p < a ? y = Math.round(r / Math.cos(d * s) - a) : d > 0 && r + c * p > l && (y = Math.round((o - r) / Math.cos(d * s))) : (r - c * p < a ? m = t.x + m * (1 - c) - a : r + (1 - c) * p > l && (m = l - t.x + m * c, x = -1), (m = Math.min(g, m)) < g && "center" === e.labelAlign && (t.x += x * (g - m - c * (g - Math.min(p, m)))), (p > m || e.autoRotation && (h.styles || {}).width) && (y = m)), y && (this.shortenLabel ? this.shortenLabel() : (f.width = Math.floor(y) + "px", (i.style || {}).textOverflow || (f.textOverflow = "ellipsis"), h.css(f)))
                    }
                    ...
                    moveLabel(t, e) {
                        ...
                        }), !o && (i.labelPos || s) && (n = i.labelPos || s.xy, i.movedLabel = i.createLabel(t, e, n), i.movedLabel && i.movedLabel.attr({opacity: 0}))
                    }

                    render(t, e, i) {
                        let s = this.axis, r = s.horiz, n = this.pos, a = u(this.tickmarkOffset, s.tickmarkOffset),
                            l = this.getPosition(r, n, a, e), d = l.x, c = l.y, p = s.pos, g = p + s.len, f = r ? d : c;
                    ...
                    renderGridLine(t, e) {
                        let i = this.axis, s = i.options, r = {}, o = this.pos, n = this.type,
                            a = u(this.tickmarkOffset, i.tickmarkOffset), l = i.chart.renderer, h = this.gridLine, d,
                    ...
                    renderMark(t, e) {
                        let i = this.axis, s = i.options, r = i.chart.renderer, o = this.type,
                            n = i.tickSize(o ? o + "Tick" : "tick"), a = t.x, l = t.y,
                            h = u(s["minor" !== o ? "tickWidth" : "minorTickWidth"], !o && i.isXAxis ? 1 : 0),
                            d = s["minor" !== o ? "tickColor" : "minorTickColor"], c = this.mark, p = !c;
                    ...
                    renderLabel(t, e, i, s) {
                        let r = this.axis, o = r.horiz, n = r.options, a = this.label, l = n.labels, h = l.step,
                            c = u(this.tickmarkOffset, r.tickmarkOffset), p = t.x, g = t.y, f = !0;
                ...
                let {animObject: l} = t, {
                        xAxis: h,
                        yAxis: d
                    } = e, {defaultOptions: c} = s, {registerEventOptions: p} = r, {deg2rad: u} = o, {
                        arrayMax: g,
                        arrayMin: f,
                        clamp: m,
                        correctFloat: x,
                    ...
                    z = (t, e) => O(e, void 0, void 0, D(t.options.allowDecimals, e < .5 || void 0 !== t.tickAmount), !!t.tickAmount);
                ...
                class N {
                    ...
                    init(t, e, i = this.coll) {
                        let s = "xAxis" === i, r = this.isZAxis || (t.inverted ? !s : s);
                        this.chart = t, this.horiz = r, this.isXAxis = s, this.coll = i, C(this, "init", {userOptions: e}), this.opposite = D(e.opposite, this.opposite), this.side = D(e.side, this.side, r ? this.opposite ? 0 : 2 : this.opposite ? 1 : 3), this.setOptions(e);
                        let o = this.options, n = o.labels, a = o.type;
                    ...
                    setOptions(t) {
                        let e = this.horiz ? {
                            labels: {autoRotation: [-45], padding: 4},
                            margin: 15
                        } : {labels: {padding: 1}, title: {rotation: 90 * this.side}};
                        this.options = L(e, c[this.coll], t), C(this, "afterSetOptions", {userOptions: t})
                    }

                    defaultLabelFormatter() {
                        let t = this.axis, {numberFormatter: e} = this.chart, i = T(this.value) ? this.value : NaN,
                            s = t.chart.time, r = t.categories, o = this.dateTimeLabelFormat, n = c.lang,
                            a = n.numericSymbols, l = n.numericSymbolMagnitude || 1e3,
                            h = t.logarithmic ? Math.abs(i) : t.tickInterval, d = a && a.length, p, u;
                        if (r) u = `${this.value}`; else if (o) u = s.dateFormat(o, i); else if (d && a && h >= 1e3) for (; d-- && void 0 === u;) h >= (p = Math.pow(l, d + 1)) && 10 * i % p == 0 && null !== a[d] && 0 !== i && (u = e(i / p, -1) + a[d]);
                    ...
                    translate(t, e, i, s, r, o) {
                        ...
                        let l = n.minPixelPadding,
                            h = (n.isOrdinal || n.brokenAxis?.hasBreaks || n.logarithmic && r) && n.lin2val, d = 1,
                            c = 0, p = s && n.old ? n.old.transA : n.transA, u = 0;
                    ...
                    getPlotLinePath(t) {
                        let e = this, i = e.chart, s = e.left, r = e.top, o = t.old, n = t.value, a = t.lineWidth,
                            l = o && i.oldChartHeight || i.chartHeight, h = o && i.oldChartWidth || i.chartWidth,
                            d = e.transB, c = t.translatedValue, p = t.force, u, g, f, x, y;
                        ...
                        return C(this, "getPlotLinePath", v, function (t) {
                            u = f = (c = m(c = D(c, e.translate(n, void 0, void 0, o)), -1e5, 1e5)) + d, g = x = l - c - d, T(c) ? e.horiz ? (g = r, x = l - e.bottom + (e.options.isInternal ? 0 : i.scrollablePixelsY || 0), u = f = b(u, s, s + e.width)) : (u = s, f = h - e.right + (i.scrollablePixelsX || 0), g = x = b(g, r, r + e.height)) : (y = !0, p = !1), t.path = y && !p ? void 0 : i.renderer.crispLine([["M", u, g], ["L", f, x]], a || 1)
                        }), v.path
                    }

                    getLinearTickPositions(t, e, i) {
                        let s, r, o;
                        let n = x(Math.floor(e / t) * t), a = x(Math.ceil(i / t) * t), l = [];
                    ...
                    getMinorTickPositions() {
                        let t = this.options, e = this.tickPositions, i = this.minorTickInterval,
                            s = this.pointRangePadding || 0, r = (this.min || 0) - s, o = (this.max || 0) + s,
                            n = o - r, a = [], l;
                        if (n && n / i < this.len / 3) {
                            let s = this.logarithmic;
                            if (s) this.paddedTicks.forEach(function (t, e, r) {
                                e && a.push.apply(a, s.getLogTickPositions(i, r[e - 1], r[e], !0))
                            }); else if (this.dateTime && "auto" === this.getMinorTickInterval()) a = a.concat(this.getTimeTicks(this.dateTime.normalizeTimeTickInterval(i), r, o, t.startOfWeek)); else for (l = r + (e[0] - r) % i; l <= o && l !== a[0]; l += i) a.push(l)
                        }
                        return 0 !== a.length && this.trimTicks(a), a
                    }

                    adjustForMinRange() {
                        let t = this.options, e = this.logarithmic, {max: i, min: s, minRange: r} = this, o, n, a, l;
                    ...
                    setAxisTranslation() {
                        let t = this, e = t.max - t.min, i = t.linkedParent, s = !!t.categories, r = t.isXAxis,
                            o = t.axisPointRange || 0, n, a = 0, l = 0, h, d = t.transA;
                    ...
                    setTickInterval(t) {
                        let {
                                ...
                                softMax: f,
                                softMin: m
                            } = l, b = T(g) && i[this.coll]?.[g], v = l.tickPixelInterval, S = l.maxPadding,
                            M = l.minPadding, w = 0, A,
                            P = T(l.tickInterval) && l.tickInterval >= 0 ? l.tickInterval : void 0, L, O, E, j;
                    ...
                    setTickPositions() {
                        let t = this.options, e = t.tickPositions, i = t.tickPositioner,
                            s = this.getMinorTickInterval(), r = !this.isPanning, o = r && t.startOnTick,
                            n = r && t.endOnTick, a = [], l;
                    ...
                    alignToOthers() {
                        let t;
                        let e = this, i = e.chart, s = [this], r = e.options, o = i.options.chart,
                            n = "yAxis" === this.coll && o.alignThresholds, a = [];
                    ...
                    adjustTickAmount() {
                        let t = this, {
                            ...
                            } = t, l = o?.length, h = D(t.threshold, t.softThreshold ? 0 : null), d, c, p = t.tickInterval,
                            u, g = () => o.push(x(o[o.length - 1] + p)), f = () => o.unshift(x(o[0] - p));
                    ...
                    autoLabelAlign(t) {
                        let e = (D(t, 0) - 90 * this.side + 720) % 360, i = {align: "center"};
                    ...
                    tickSize(t) {
                        let e = this.options,
                            ...
                            s = e["tick" === t ? "tickLength" : "minorTickLength"], r;
                    ...
                    unsquish() {
                        let t = this.options.labels, e = t.padding || 0, i = this.horiz, s = this.tickInterval,
                            r = this.len / (((this.categories ? 1 : 0) + this.max - this.min) / s), o = t.rotation,
                            n = x(.8 * this.labelMetrics().h), a = Math.max(this.max - this.min, 0), l = function (t) {
                                let i = (t + 2 * e) / (r || 1);
                    ...
                    renderUnsquish() {
                        let t = this.chart, e = t.renderer, i = this.tickPositions, s = this.ticks,
                            r = this.options.labels, o = r.style, n = this.horiz, a = this.getSlotWidth(),
                            l = Math.max(1, Math.round(a - (n ? 2 * (r.padding || 0) : r.distance || 0))), h = {},
                            d = this.labelMetrics(), c = o.textOverflow, p, u, g = 0, f, m;
                        ...
                        }), this.maxLabelLength = g, this.autoRotation) g > l && g > d.h ? h.rotation = this.labelRotation : this.labelRotation = 0; else if (a && (p = l, !c)) for (u = "clip", m = i.length; !n && m--;) (f = s[i[m]].label) && ("ellipsis" === f.styles.textOverflow ? f.css({textOverflow: "clip"}) : f.textPxLength > a && f.css({width: a + "px"}), f.getBBox().height > this.len / i.length - (d.h - d.f) && (f.specificTextOverflow = "ellipsis"));
                        h.rotation && (p = g > .5 * t.chartHeight ? .33 * t.chartHeight : g, c || (u = "ellipsis")), this.labelAlign = r.align || this.autoLabelAlign(this.labelRotation), this.labelAlign && (h.align = this.labelAlign), i.forEach(function (t) {
                            let e = s[t], i = e && e.label, r = o.width, n = {};
                            i && (i.attr(h), e.shortenLabel ? e.shortenLabel() : p && !r && "nowrap" !== o.whiteSpace && (p < i.textPxLength || "SPAN" === i.element.tagName) ? (n.width = p + "px", c || (n.textOverflow = i.specificTextOverflow || u), i.css(n)) : !i.styles.width || n.width || r || i.css({width: null}), delete i.specificTextOverflow, e.rotation = h.rotation)
                    ...
                    addTitle(t) {
                        let e;
                        let i = this.chart.renderer, s = this.horiz, r = this.opposite, o = this.options.title,
                        ...
                        this.axisTitle || ((e = o.textAlign) || (e = (s ? {
                            ...
                            align: e
                        }).addClass("highcharts-axis-title"), n || this.axisTitle.css(L(o.style)), this.axisTitle.add(this.axisGroup), this.axisTitle.isNew = !0), n || o.style.width || this.isRadial || this.axisTitle.css({width: this.len + "px"}), this.axisTitle[t ? "show" : "hide"](t)
                    }
                    ...
                    createGroups() {
                        let {axisParent: t, chart: e, coll: i, options: s} = this, r = e.renderer,
                            o = (e, o, n) => r.g(e).attr({zIndex: n}).addClass(`highcharts-${i.toLowerCase()}${o} ` + (this.isRadial ? `highcharts-radial-axis${o} ` : "") + (s.className || "")).add(t);
                    ...
                    getOffset() {
                        let t = this, {
                                ...
                                tickPositions: n,
                                coll: a
                            } = t, l = e.inverted && !t.isZAxis ? [1, 0, 3, 2][r] : r, h = t.hasData(), d = s.title,
                            c = s.labels, p = T(s.crossing), u = e.axisOffset, g = e.clipOffset, f = [-1, 1, 1, -1][r],
                            m, x = 0, b, v = 0, k = 0, S, M;
                    ...
                    getLinePath(t) {
                        let e = this.chart, i = this.opposite, s = this.offset, r = this.horiz,
                    ...
                    getTitlePosition(t) {
                        let e = this.horiz, i = this.left, s = this.top, r = this.len, o = this.options.title,
                            n = e ? i : s, a = this.opposite, l = this.offset, h = o.x, d = o.y,
                            c = this.chart.renderer.fontMetrics(t),
                            p = t ? Math.max(t.getBBox(!1, 0).height - c.h - 1, 0) : 0,
                            u = {low: n + (e ? 0 : r), middle: n + r / 2, high: n + (e ? r : 0)}[o.align],
                    ...
                    render() {
                        let t, e;
                        let i = this, s = i.chart, r = i.logarithmic, a = s.renderer, h = i.options, d = i.isLinked,
                            c = i.tickPositions, p = i.axisTitle, u = i.ticks, g = i.minorTicks, f = i.alternateBands,
                            m = h.stackLabels, x = h.alternateGridColor, y = h.crossing, b = i.tickmarkOffset,
                            v = i.axisLine, k = i.showAxis, S = l(a.globalAnimation);
                        ...
                        }), v && (v[v.isPlaced ? "animate" : "attr"]({d: this.getLinePath(v.strokeWidth())}), v.isPlaced = !0, v[k ? "show" : "hide"](k)), p && k && (p[p.isNew ? "attr" : "animate"](i.getTitlePosition(p)), p.isNew = !1), m && m.enabled && i.stacking && i.stacking.renderStackTotals(), i.old = {
                            len: i.len,
                            max: i.max,
                            min: i.min,
                            transA: i.transA,
                    ...
                    destroy(t) {
                        ...
                        if (C(this, "destroy", {keepEvents: t}), t || I(e), [e.ticks, e.minorTicks, e.alternateBands].forEach(function (t) {
                            b(t)
                        }), i) {
                            let t = i.length;
                            for (; t--;) i[t].destroy()
                    ...
                    drawCrosshair(t, e) {
                        let s = this.crosshair, r = D(s && s.snap, !0), o = this.chart, n, a, l, h = this.cross, d;
                        if (C(this, "drawCrosshair", {
                            ...
                            l = this.categories && !this.isRadial, h || (this.cross = h = o.renderer.path().addClass("highcharts-crosshair highcharts-crosshair-" + (l ? "category " : "thin ") + (s.className || "")).attr({zIndex: D(s.zIndex, 2)}).add(), !o.styledMode && (h.attr({
                                stroke: s.color || (l ? i.parse("#ccd3ff").setOpacity(.25).get() : "#cccccc"),
                                "stroke-width": D(s.width, 1)
                            }).css({"pointer-events": "none"}), s.dashStyle && h.attr({dashstyle: s.dashStyle}))), h.show().attr({d: n}), l && !s.width && h.attr({"stroke-width": this.transA}), this.cross.e = t
                    ...
                    class a {
                        ...
                        normalizeTimeTickInterval(t, e) {
                            let i = e || [["millisecond", [1, 2, 5, 10, 20, 25, 50, 100, 200, 500]], ["second", [1, 2, 5, 10, 15, 30]], ["minute", [1, 2, 5, 10, 15, 30]], ["hour", [1, 2, 3, 4, 6, 8, 12]], ["day", [1, 2]], ["week", [1, 2]], ["month", [1, 2, 3, 4, 6]], ["year", null]],
                                n = i[i.length - 1], a = o[n[0]], l = n[1], h;
                ...
                return function (t) {
                    ...
                    class n {
                        ...
                        getLogTickPositions(t, e, i, o) {
                            let n = this.axis, a = n.len, l = n.options, h = [];
                            if (o || (this.minorAutoInterval = void 0), t >= .5) t = Math.round(t), h = n.getLinearTickPositions(t, e, i); else if (t >= .08) {
                                let s, r, n, a, l, d, c;
                                let p = Math.floor(e);
                                for (s = t > .3 ? [1, 2, 4] : t > .15 ? [1, 2, 4, 6, 8] : [1, 2, 3, 4, 5, 6, 7, 8, 9], r = p; r < i + 1 && !c; r++) for (n = 0, a = s.length; n < a && !c; n++) (l = this.log2lin(this.lin2log(r) * s[n])) > e && (!o || d <= i) && void 0 !== d && h.push(d), d > i && (c = !0), d = l
                            } else {
                                let d = this.lin2log(e), c = this.lin2log(i),
                                    p = o ? n.getMinorTickInterval() : l.tickInterval,
                                    u = l.tickPixelInterval / (o ? 5 : 1), g = o ? a / n.tickPositions.length : a;
                ...
                return function (t) {
                    ...
                    function n(t, i) {
                        let s = this.userOptions, r = new e(this, t);
                    ...
                    function l(t, e, i) {
                        i = i || this.options;
                        let s = this.getPlotLinePath({value: e, force: !0, acrossPanes: i.acrossPanes}), o = [],
                            n = this.horiz,
                        ...
                        if (l && s) for (a && (c = l.toString() === s.toString(), d = 0), h = 0; h < l.length; h += 2) {
                            let t = l[h], e = l[h + 1], i = s[h], r = s[h + 1];
                    ...
                    function d(t) {
                        let e = this.plotLinesAndBands, s = this.options, r = this.userOptions;
                        if (e) {
                            let o = e.length;
                ...
                class c {
                    ...
                    render() {
                        ...
                        let {axis: t, options: e} = this, {horiz: i, logarithmic: s} = t, {
                            ...
                            y = e.label, {label: b, svgElem: v} = this, k = [], S, C = r(f) && r(g), M = r(m), w = !v,
                            A = {class: "highcharts-plot-" + (C ? "band " : "line ") + (e.className || "")},
                            T = C ? "bands" : "lines";
                        ...
                        }), this.eventsAdded = !0), (w || !v.d) && k?.length ? v.attr({d: k}) : v && (k ? (v.show(), v.animate({d: k})) : v.d && (v.hide(), b && (this.label = b = b.destroy()))), y && (r(y.text) || r(y.formatter)) && k?.length && t.width > 0 && t.height > 0 && !k.isFlat ? (y = l({
                    ...
                    renderLabel(t, e, r, o) {
                        let n = this.axis, a = n.chart.renderer, h = this.label;
                        ...
                        let d = e.xBounds || [e[0][1], e[1][1], r ? e[2][1] : e[0][1]],
                            c = e.yBounds || [e[0][2], e[1][2], r ? e[2][2] : e[0][2]], p = s(d), u = s(c);
                        if (h.align(t, !1, {
                            x: p,
                            y: u,
                            width: i(d) - p,
                            ...
                            h.css({width: (90 === h.rotation ? n.height - (h.alignAttr.y - n.top) : e - (h.alignAttr.x - n.left)) + "px"})
                        }
                        h.show(!0)
                    }
                ...
                class T {
                    ...
                    getAnchor(t, e) {
                        let i;
                        let {chart: s, pointer: r} = this, o = s.inverted, n = s.plotTop, a = s.plotLeft;
                    ...
                    getLabel({anchorX: t, anchorY: e} = {anchorX: 0, anchorY: 0}) {
                        let s = this, o = this.chart.styledMode, n = this.options, a = this.split && this.allowShared,
                        ...
                        if (!this.label) {
                            if (this.outside) {
                                let t = this.chart.options.chart.style, e = r.getRendererType();
                            ...
                            if (a ? this.label = h.g("tooltip") : (this.label = h.label("", t, e, n.shape, void 0, void 0, n.useHTML, void 0, "tooltip").attr({
                                padding: n.padding,
                                r: n.borderRadius
                            }), o || this.label.attr({
                                fill: n.backgroundColor,
                                "stroke-width": n.borderWidth || 0
                            }).css(n.style).css({pointerEvents: n.style.pointerEvents || (this.shouldStickOnContact() ? "auto" : "none")})), s.outside) {
                                let t = this.label;
                                [t.xSetter, t.ySetter].forEach((e, i) => {
                                    t[i ? "ySetter" : "xSetter"] = r => {
                                        e.call(t, s.distance), t[i ? "y" : "x"] = r, l && (l.style[i ? "top" : "left"] = `${r}px`)
                                    }
                                })
                            }
                    ...
                    getPosition(t, e, i) {
                        let {distance: s, chart: r, outside: o, pointer: n} = this, {
                                ...
                                plotTop: h,
                                polar: d
                            } = r, {plotX: c = 0, plotY: p = 0} = i, u = {}, g = a && i.h || 0, {
                                height: f,
                                width: m
                            } = this.getPlayingField(), x = n.getChartPosition(), y = t => t * x.scaleX,
                            b = t => t * x.scaleY, v = i => {
                                let n = "x" === i;
                        ...
                        let A = !this.followPointer && C(i.ttBelow, !d && !a === w),
                            T = function (t, e, i, r, n, a, l) {
                                let h = o ? "y" === t ? b(s) : y(s) : s, d = (i - r) / 2, c = r < n - s,
                                    p = n + s + r < e, f = n - h - i + d, m = n + h - d;
                                if (A && p) u[t] = m; else if (!A && c) u[t] = f; else if (c) u[t] = Math.min(l - r, f - g < 0 ? f : f - g); else {
                                    if (!p) return !1;
                    ...
                    move(t, e, i, s) {
                        let r = this, o = a(!r.isHidden && r.options.animation),
                            n = r.followPointer || (r.len || 0) > 1, l = {x: t, y: e};
                        n || (l.anchorX = i, l.anchorY = s), o.step = () => r.drawTracker(), r.getLabel().animate(l, o)
                    }

                    refresh(t, e) {
                        let {chart: i, options: s, pointer: r, shared: n} = this, a = w(t), h = a[0], d = [],
                            c = s.format, p = s.formatter || this.defaultFormatter, u = i.styledMode, g = {},
                            f = this.allowShared;
                        if (!s.enabled || !h.series) return;
                        o.clearTimeout(this.hideTimer), this.allowShared = !(!b(t) && t.series && t.series.noSharedTooltip), f = f && !this.allowShared, this.followPointer = !this.split && h.series.tooltipOptions.followPointer;
                        let m = this.getAnchor(t, e), x = m[0], v = m[1];
                        ...
                        let S = k(c) ? l(c, g, i) : p.call(g, this), M = h.series;
                        if (this.distance = C(M.tooltipOptions.distance, 16), !1 === S) this.hide(); else {
                            if (this.split && this.allowShared) this.renderSplit(S, a); else {
                                let t = x, o = v;
                                if (e && r.isDirectTouch && (t = e.chartX - i.plotLeft, o = e.chartY - i.plotTop), i.polar || !1 === M.options.clip || a.some(e => r.isDirectTouch || e.series.shouldShowTooltip(t, o))) {
                                    ...
                                    }), u || t.attr({stroke: s.borderColor || h.color || M.color || "#666666"}), this.updatePosition({
                                        plotX: x,
                                        plotY: v,
                                        negative: h.negative,
                                        ttBelow: h.ttBelow,
                    ...
                    renderSplit(t, e) {
                        let i = this, {
                                ...
                                pointer: v
                            } = i, {scrollLeft: S = 0, scrollTop: M = 0} = s.scrollablePlotArea?.scrollingContainer || {},
                            w = i.outside && "number" != typeof u ? d.documentElement.getBoundingClientRect() : {
                                left: S,
                                right: S + r,
                                top: M,
                                bottom: M + o
                            }, A = i.getLabel(), T = this.renderer || s.renderer,
                            P = !!(s.xAxis[0] && s.xAxis[0].opposite), {left: L, top: O} = v.getChartPosition(),
                            E = l + M, D = 0, j = n - h;
                        ...
                        let B = t.slice(0, e.length + 1).reduce(function (t, s, r) {
                            if (!1 !== s && "" !== s) {
                                let o = e[r - 1] || {isHeader: !0, plotX: e[0].plotX, plotY: n, series: {}},
                                    h = o.isHeader, d = h ? i : o.series, c = d.tt = function (t, e, s) {
                                        let r = t, {isHeader: o, series: n} = e;
                                        if (!r) {
                                        ...
                                        return r.isActive = !0, r.attr({text: s}), f || r.css(y.style).attr({stroke: y.borderColor || e.color || n.color || "#333333"}), r
                                    }(d.tt, o, s.toString()), p = c.getBBox(), u = p.width + c.strokeWidth();
                                h && (j += D = p.height, P && (E -= D));
                                let {anchorX: x, anchorY: v} = function (t) {
                                    let e, i;
                                    let {isHeader: s, plotX: r = 0, plotY: o = 0, series: h} = t;
                                    if (s) e = Math.max(a + r, a), i = l + n / 2; else {
                                        let {xAxis: t, yAxis: s} = h;
                                        e = t.pos + g(r, -m, t.len + m), h.shouldShowTooltip(0, s.pos - l + o, {ignoreX: !0}) && (i = s.pos + o)
                                    }
                                    return {anchorX: e = g(e, w.left - m, w.right + m), anchorY: i}
                                }(o);
                                if ("number" == typeof v) {
                                    let e = p.height + 1, s = b ? b.call(i, u, e, o) : I(x, v, h, u);
                                    t.push({
                                        align: b ? 0 : void 0,
                                        anchorX: x,
                                        anchorY: v,
                        ...
                        B.forEach(function (t) {
                            ...
                            let {x: e, anchorX: s, anchorY: r, pos: o, point: {isHeader: n}} = t, a = {
                        ...
                        c && A.attr({opacity: 1 === A.opacity ? .999 : 1})
                    }
                    ...
                    tooltipFooterHeaderFormatter(t, e) {
                        let i = t.series, s = i.tooltipOptions, r = i.xAxis, o = r && r.dateTime,
                            n = {isFooter: e, labelConfig: t}, a = s.xDateFormat,
                    ...
                    updatePosition(t) {
                        let {
                                ...
                                pointer: o,
                                renderer: n
                            } = this, {height: a = 0, width: l = 0} = this.getLabel(), {
                                left: h,
                                top: d,
                                scaleX: c,
                                scaleY: p
                            } = o.getChartPosition(), u = (r.positioner || this.getPosition).call(this, l, a, t),
                            g = (t.plotX || 0) + e.plotLeft, m = (t.plotY || 0) + e.plotTop, x;
                        n && i && (r.positioner && (u.x += h - s, u.y += d - s), x = (r.borderWidth || 0) + 2 * s + 2, n.setSize(l + x, a + x, !1), (1 !== c || 1 !== p) && (f(i, {transform: `scale(${c}, ${p})`}), g *= c, m *= p), g += h - u.x, m += d - u.y), this.move(Math.round(u.x), Math.round(u.y || 0), g, m)
                    }
                }
                ...
                let {animObject: o} = e, {defaultOptions: n} = i, {format: a} = s, {
                    addEvent: l,
                    crisp: h,
                    erase: d,
                    extend: c,
                ...
                class C {
                    animateBeforeDestroy() {
                        ...
                        i.singular.forEach(function (i) {
                            ...
                            t[e].forEach(function (e) {
                                e.element && e.animate(c({x: t.startXPos}, e.startYPos ? {
                                    x: e.startXPos,
                                    y: e.startYPos
                                } : {}))
                            })
                    ...
                    applyOptions(t, e) {
                        ...
                        return c(this, t = C.prototype.optionsToObject.call(this, t)), this.options = this.options ? c(this.options, t) : t, t.group && delete this.group, t.dataLabels && delete this.dataLabels, s && (this.y = C.prototype.getNestedProperty.call(this, s)), this.selected && (this.state = "select"), "name" in this && void 0 === e && i.xAxis && i.xAxis.hasNames && (this.x = i.xAxis.nameToX(this)), void 0 === this.x && i ? this.x = e ?? i.autoIncrement() : m(t.x) && i.options.relativeXValue && (this.x = i.autoIncrement(t.x)), this.isNull = this.isValid && !this.isValid(), this.formatPrefix = this.isNull ? "null" : "point", this
                    }

                    destroy() {
                        if (!this.destroyed) {
                            let t = this, e = t.series, i = e.chart, s = e.options.dataSorting, r = i.hoverPoints,
                                n = o(t.series.chart.renderer.globalAnimation), a = () => {
                    ...
                    getGraphicalProps(t) {
                        let e, i;
                        let s = this, r = [], o = {singular: [], plural: []};
                        for ((t = t || {
                            graphic: 1,
                            dataLabel: 1
                    ...
                    optionsToObject(t) {
                        let e = this.series, i = e.options.keys, s = i || e.pointArrayMap || ["y"], r = s.length,
                            o = {}, n, a = 0, l = 0;
                        if (m(t) || null === t) o[s[0]] = t; else if (g(t)) for (!i && t.length > r && ("string" == (n = typeof t[0]) ? o.name = t[0] : "number" === n && (o.x = t[0]), a++); l < r;) i && void 0 === t[a] || (s[l].indexOf(".") > 0 ? C.prototype.setNestedProperty(o, t[a], s[l]) : o[s[l]] = t[a]), a++, l++; else "object" == typeof t && (o = t, t.dataLabels && (e.hasDataLabels = () => !0), t.marker && (e._hasPointMarkers = !0));
                        return o
                    }
                    ...
                    resolveColor() {
                        let t = this.series, e = t.chart.options.chart, i = t.chart.styledMode, s, r, o = e.colorCount,
                            n;
                    ...
                    tooltipFormatter(t) {
                        let e = this.series, i = e.tooltipOptions, s = b(i.valueDecimals, ""), r = i.valuePrefix || "",
                            o = i.valueSuffix || "";
                    ...
                    update(t, e, i, s) {
                        let r;
                        let o = this, n = o.series, a = o.graphic, l = n.chart, h = n.options;

                        function d() {
                            o.applyOptions(t);
                            let s = a && o.hasMockGraphic, d = null === o.y ? !s : s;
                        ...
                        e = b(e, !0), !1 === s ? d() : o.firePointEvent("update", {options: t}, d)
                    }
                    ...
                    manageEvent(t) {
                        ...
                        f(i) && (!this.hcEvents?.[t] || -1 === this.hcEvents?.[t]?.map(t => t.fn).indexOf(i)) ? (this.importedUserEvent?.(), this.importedUserEvent = l(this, t, i)) : this.importedUserEvent && !i && this.hcEvents?.[t] && (k(this, t), delete this.hcEvents[t], Object.keys(this.hcEvents) || delete this.importedUserEvent)
                    }

                    setState(e, i) {
                        let s = this.series, r = this.state, o = s.options.states[e || "normal"] || {},
                            a = n.plotOptions[s.type].marker && s.options.marker, l = a && !1 === a.enabled,
                            h = a && a.states && a.states[e || "normal"] || {}, d = !1 === h.enabled,
                            u = this.marker || {}, g = s.chart, f = a && s.markerAttribs, x = s.halo, y, v, k,
                            S = s.stateMarkerGraphic, C;
                        ...
                        if (this.state = e, f && (y = s.markerAttribs(this, e)), this.graphic && !this.hasMockGraphic) {
                            if (r && this.graphic.removeClass("highcharts-point-" + r), e && this.graphic.addClass("highcharts-point-" + e), !g.styledMode) {
                                ...
                                s.options.inactiveOtherPoints && m(t) && (this.dataLabels || []).forEach(function (e) {
                                    e && !e.hasClass("highcharts-data-label-hidden") && (e.animate({opacity: t}, k), e.connector && e.connector.animate({opacity: t}, k))
                        ...
                        let M = o.halo, w = this.graphic || S, A = w && w.visibility || "inherit";
                        M && M.size && w && "hidden" !== A && !this.isCluster ? (x || (s.halo = x = g.renderer.path().add(w.parentGroup)), x.show()[i ? "animate" : "attr"]({d: this.haloPath(M.size)}), x.attr({
                        ...
                        }, t.filterUserAttributes(M.attributes || {})))) : x?.point?.haloPath && !x.point.destroyed && x.animate({d: x.point.haloPath(0)}, null, x.hide), p(this, "afterSetState", {state: e})
                    }
                ...
                var s;
                let {parse: r} = t, {charts: o, composed: n, isTouchDevice: a} = e, {
                    addEvent: l,
                    attr: h,
                    css: d,
                    extend: c,
                ...
                class k {
                    ...
                    destroy() {
                        let t = this;
                        this.eventsToUnbind.forEach(t => t()), this.eventsToUnbind = [], !e.chartCount && (k.unbindDocumentMouseUp && k.unbindDocumentMouseUp.forEach(t => t()), k.unbindDocumentTouchEnd && (k.unbindDocumentTouchEnd = k.unbindDocumentTouchEnd())), clearInterval(t.tooltipTimeout), m(t, function (e, i) {
                            t[i] = void 0
                        })
                    }
                    ...
                    getSelectionMarkerAttrs(t, e) {
                        ...
                        return u(this, "getSelectionMarkerAttrs", i, i => {
                            let s;
                            let {chart: r, zoomHor: o, zoomVert: n} = this, {mouseDownX: a = 0, mouseDownY: l = 0} = r,
                                h = i.attrs;
                    ...
                    drag(t) {
                        let {chart: e} = this, {mouseDownX: i = 0, mouseDownY: s = 0} = e, {
                            ...
                            p = f(o) ? o.enabled : o, u = n && t[`${n}Key`], g = t.chartX, m = t.chartY, x,
                        ...
                        if ((!y || !y.touch) && (g < l ? g = l : g > l + d && (g = l + d), m < h ? m = h : m > h + c && (m = h + c), this.hasDragged = Math.sqrt(Math.pow(i - g, 2) + Math.pow(s - m, 2)), this.hasDragged > 10)) {
                            ...
                            (e.hasCartesianSeries || e.mapView) && this.hasZoom && x && !u && !y && (this.selectionMarker = y = e.renderer[n](), y.attr({
                                ...
                                zIndex: 7
                            }).add(), e.styledMode || y.attr({fill: a || r("#334eff").setOpacity(.25).get()})), y && y.attr(d), x && !y && p && e.pan(t, o)
                        }
                    }
                    ...
                    getHoverData(t, e, i, s, r, o) {
                        ...
                        }, l = e, h, d = {chartX: o ? o.chartX : void 0, chartY: o ? o.chartY : void 0, shared: r};
                        ...
                        }) : n.push(c)), u(this, "afterGetHoverData", d = {hoverPoint: c}), {
                    ...
                    normalize(t, e) {
                        ...
                        return c(t, {chartX: Math.round(r /= e.scaleX), chartY: Math.round(o /= e.scaleY)})
                    }

                    onContainerClick(t) {
                        let e = this.chart, i = e.hoverPoint, s = this.normalize(t), r = e.plotLeft, o = e.plotTop;
                        !e.cancelClick && (i && this.inClass(s.target, "highcharts-tracker") ? (u(i.series, "click", c(s, {point: i})), e.hoverPoint && i.firePointEvent("click", s)) : (c(s, this.getCoordinates(s)), e.isInsidePlot(s.chartX - r, s.chartY - o, {visiblePlotOnly: !0}) && u(e, "click", s)))
                    }
                    ...
                    onContainerMouseLeave(t) {
                        let {pointer: e} = o[y(k.hoverChartIndex, -1)] || {};
                    ...
                    pinch(t) {
                        let e = this, {chart: i, hasZoom: s, lastTouches: r} = e,
                            o = [].map.call(t.touches || [], t => e.normalize(t)), n = o.length,
                            a = 1 === n && (e.inClass(t.target, "highcharts-tracker") && i.runTrackerClick || e.runChartClick),
                            l = i.tooltip, h = 1 === n && y(l?.options.followTouchMove, !0);
                        n > 1 ? e.initiated = !0 : h && (e.initiated = !1), s && e.initiated && !a && !1 !== t.cancelable && t.preventDefault(), "touchstart" === t.type ? (e.pinchDown = o, e.res = !0, i.mouseDownX = t.chartX) : h ? this.runPointActions(e.normalize(t)) : r && (u(i, "touchpan", {
                            originalEvent: t,
                            touches: o
                        }, () => {
                            let e = t => {
                    ...
                    reset(t, e) {
                        let i = this.chart, s = i.hoverSeries, r = i.hoverPoint, o = i.hoverPoints, n = i.tooltip,
                            a = n && n.shared ? o : r;
                    ...
                    runPointActions(t, e, i) {
                        let s = this.chart, r = s.series,
                            n = s.tooltip && s.tooltip.options.enabled ? s.tooltip : void 0, a = !!n && n.shared,
                            h = e || s.hoverPoint, d = h && h.series || s.hoverSeries,
                        ...
                        if (h && (i || h !== s.hoverPoint || n && n.isHidden)) {
                            ...
                            let e = n.getAnchor([{}], t);
                            s.isInsidePlot(e[0], e[1], {visiblePlotOnly: !0}) && n.updatePosition({
                                plotX: e[0],
                                plotY: e[1]
                            })
                        }
                    ...
                    setDOMEvents() {
                        ...
                        t.onmousedown = this.onContainerMouseDown.bind(this), t.onmousemove = this.onContainerMouseMove.bind(this), t.onclick = this.onContainerClick.bind(this), this.eventsToUnbind.push(l(t, "mouseenter", this.onContainerMouseEnter.bind(this)), l(t, "mouseleave", this.onContainerMouseLeave.bind(this))), k.unbindDocumentMouseUp || (k.unbindDocumentMouseUp = []), k.unbindDocumentMouseUp.push(l(e, "mouseup", this.onDocumentMouseUp.bind(this)));
                        let i = this.chart.renderTo.parentElement;
                        for (; i && "BODY" !== i.tagName;) this.eventsToUnbind.push(l(i, "scroll", () => {
                            delete this.chartPosition
                        })), i = i.parentElement;
                        this.eventsToUnbind.push(l(t, "touchstart", this.onContainerTouchStart.bind(this), {passive: !1}), l(t, "touchmove", this.onContainerTouchMove.bind(this), {passive: !1})), k.unbindDocumentTouchEnd || (k.unbindDocumentTouchEnd = l(e, "touchend", this.onDocumentTouchEnd.bind(this), {passive: !1})), this.setPointerCapture(), l(this.chart, "redraw", this.setPointerCapture.bind(this))
                    }
                    ...
                    setHoverChartIndex(t) {
                        let i = this.chart, s = e.charts[y(k.hoverChartIndex, -1)];
                        if (s && s !== i) {
                    ...
                    touch(t, e) {
                        ...
                        this.setHoverChartIndex(), 1 === (t = this.normalize(t)).touches.length ? s.isInsidePlot(t.chartX - s.plotLeft, t.chartY - s.plotTop, {visiblePlotOnly: !0}) && !s.openMenu ? (e && this.runPointActions(t), "touchmove" === t.type && (i = !!r[0] && Math.pow(r[0].chartX - t.chartX, 2) + Math.pow(r[0].chartY - t.chartY, 2) >= 16), y(i, !0) && this.pinch(t)) : e && this.reset() : 2 === t.touches.length && this.pinch(t)
                    }
                ...
                return function (t) {
                    function e(t, e, o) {
                        let n = this.legendItem = this.legendItem || {}, {
                                chart: a,
                                options: l
                            } = this, {baseline: h = 0, symbolWidth: d, symbolHeight: c} = t, p = this.symbol || "circle",
                            u = c / 2, g = a.renderer, f = n.group, m = h - Math.round(c * (o ? .4 : .3)), x = {}, y,
                            b = l.marker, v = 0;
                        if (a.styledMode || (x["stroke-width"] = Math.min(l.lineWidth || 0, 24), l.dashStyle ? x.dashstyle = l.dashStyle : "square" === l.linecap || (x["stroke-linecap"] = "round")), n.line = g.path().addClass("highcharts-graph").attr(x).add(f), o && (n.area = g.path().addClass("highcharts-area").add(f)), x["stroke-linecap"] && (v = Math.min(n.line.strokeWidth(), d) / 2), d) {
                            let t = [["M", v, m], ["L", d - v, m]];
                            n.line.attr({d: t}), n.area?.attr({d: [...t, ["L", d - v, h], ["L", v, h]]})
                        }
                        if (b && !1 !== b.enabled && d) {
                    ...
                    t.areaMarker = function (t, i) {
                        ...
                        let i = e.legendItem || {}, s = t.options, o = t.symbolHeight, n = s.squareSymbol,
                            a = n ? o : t.symbolWidth;
                        i.symbol = this.chart.renderer.rect(n ? (t.symbolWidth - o) / 2 : 0, t.baseline - o + 1, a, o, r(t.options.symbolRadius, o / 2)).addClass("highcharts-point").attr({zIndex: 3}).add(i.group)
                    }
                }(e || (e = {})), e
                ...
                var r;
                let {defaultOptions: o} = e, {extend: n, extendClass: a, merge: l} = s;
                return function (e) {
                    function s(t, s) {
                        let r = o.plotOptions || {}, n = s.defaultOptions, a = s.prototype;
                    ...
                    e.seriesTypes = t.seriesTypes, e.registerSeriesType = s, e.seriesType = function (t, r, h, d, c) {
                        let p = o.plotOptions || {};
                        if (r = r || "", p[t] = l(p[r], h), delete e.seriesTypes[t], s(t, a(e.seriesTypes[r] || function () {
                ...
                let {
                    animObject: d,
                    setAnimation: c
                } = t, {defaultOptions: p} = e, {registerEventOptions: u} = i, {
                    svg: g,
                    win: f
                } = s, {seriesTypes: m} = a, {
                    arrayMax: x,
                ...
                class X {
                    ...
                    updateParallelArrays(t, e, i) {
                        let s = t.series, r = I(e) ? function (i) {
                    ...
                    autoIncrement(t) {
                        let e = this.options, i = e.pointIntervalUnit, s = e.relativeXValue, r = this.chart.time,
                            o = this.xIncrement, n, a;
                    ...
                    setOptions(t) {
                        let e;
                        let i = this.chart, s = i.options.plotOptions, r = i.userOptions || {}, o = R(t),
                            n = i.styledMode, a = {plotOptions: s, userOptions: o};
                        L(this, "setOptions", a);
                        let l = a.plotOptions[this.type], h = r.plotOptions || {}, d = h.series || {},
                        ...
                        }), L(this, "afterSetOptions", {options: g}), g
                    }
                    ...
                    getCyclic(t, e, i) {
                        let s, r;
                        let o = this.chart, n = `${t}Index`, a = `${t}Counter`,
                    ...
                    findPointIndex(t, e) {
                        let i, s, r;
                        let n = t.id, a = t.x, l = this.points, h = this.options.dataSorting;
                        if (n) {
                    ...
                    updateData(t, e) {
                        let i = this.options, s = i.dataSorting, r = this.points, o = [], n = this.requireSorting,
                            a = t.length === r.length, l, h, d, c, p = !0;
                        if (this.xIncrement = null, t.forEach(function (t, e) {
                            let h;
                            let d = S(t) && this.pointClass.prototype.optionsToObject.call({series: this}, t) || {},
                                p = d.x;
                        ...
                        }, this), l) for (h = r.length; h--;) (d = r[h]) && !d.touched && d.remove && d.remove(!1, e); else !a || s && s.enabled ? p = !1 : (t.forEach(function (t, e) {
                    ...
                    setData(t, e = !0, i, s) {
                        let r = this, o = r.points, n = o && o.length || 0, a = r.options, l = r.chart,
                            h = a.dataSorting, d = r.xAxis, c = a.turboThreshold, p = this.xData, u = this.yData,
                            g = r.pointArrayMap, f = g && g.length, m = a.keys, x, y, b, v = 0, k = 1, S;
                        l.options.chart.allowMutatingData || (a.data && delete r.options.data, r.userOptions.data && delete r.userOptions.data, S = R(!0, t));
                        let C = (t = S || t || []).length;
                        if (h && h.enabled && (t = this.sortData(t)), l.options.chart.allowMutatingData && !1 !== s && C && n && !r.cropped && !r.hasGroupedData && r.visible && !r.boosted && (b = this.updateData(t, i)), !b) {
                            r.xIncrement = null, r.colorCounter = 0, this.parallelArrays.forEach(function (t) {
                                r[t + "Data"].length = 0
                            });
                            let e = c && C > c;
                            if (e) {
                                let i = r.getFirstValidPoint(t), s = r.getFirstValidPoint(t, C - 1, -1),
                                    o = t => !!(j(t) && (m || I(t[0])));
                                if (I(i) && I(s)) for (x = 0; x < C; x++) p[x] = this.autoIncrement(), u[x] = t[x]; else if (o(i) && o(s)) {
                                    if (f) {
                                        if (i.length === f) for (x = 0; x < C; x++) p[x] = this.autoIncrement(), u[x] = t[x]; else for (x = 0; x < C; x++) y = t[x], p[x] = y[0], u[x] = y.slice(1, f + 1)
                                    } else if (m && (v = m.indexOf("x"), k = m.indexOf("y"), v = v >= 0 ? v : 0, k = k >= 0 ? k : 1), 1 === i.length && (k = 0), v === k) for (x = 0; x < C; x++) p[x] = this.autoIncrement(), u[x] = t[x][k]; else for (x = 0; x < C; x++) y = t[x], p[x] = y[v], u[x] = y[k]
                                } else e = !1
                            }
                            if (!e) for (x = 0; x < C; x++) y = {series: r}, r.pointClass.prototype.applyOptions.apply(y, [t[x]]), r.updateParallelArrays(y, x);
                    ...
                    getProcessedData(t) {
                        let e = this, i = e.xAxis, s = e.options.cropThreshold, r = i?.logarithmic, o = e.isCartesian,
                            n, a, l = 0, h, d, c, p = e.xData, u = e.yData, g = !1, f = p.length;
                        ...
                        return {xData: p, yData: u, cropped: a, cropStart: l, closestPointRange: m}
                    }
                    ...
                    generatePoints() {
                        let t = this.options, e = this.processedData || t.data, i = this.processedXData,
                            s = this.processedYData, r = this.pointClass, o = i.length, n = this.cropStart || 0,
                            a = this.hasGroupedData, l = t.keys, h = [],
                            d = t.dataGrouping && t.dataGrouping.groupAll ? n : 0, c, p, u, g, f = this.data;
                        if (!f && !a) {
                            let t = [];
                        ...
                        if (this.options.keys = l, f && (o !== (c = f.length) || a)) for (g = 0; g < c; g++) g !== n || a || (g += o), f[g] && (f[g].destroyElements(), f[g].plotX = void 0);
                    ...
                    getExtremes(t, e) {
                        let i = this.xAxis, s = this.yAxis, r = [],
                            o = this.requireSorting && !this.is("column") ? 1 : 0, n = !!s && s.positiveValuesOnly,
                            a = e || this.getExtremesFromAll || this.options.getExtremesFromAll, {
                                processedXData: l,
                                processedYData: h
                            } = this, d, c, p, u, g, f, m, b = 0, v = 0, k = 0;
                        if (this.cropped && a) {
                            let t = this.getProcessedData(!0);
                            l = t.xData, h = t.yData
                        }
                        let S = (t = t || this.stackedYData || h || []).length, C = l || this.xData;
                        for (i && (b = (d = i.getExtremes()).min, v = d.max), f = 0; f < S; f++) if (u = C[f], c = (I(g = t[f]) || j(g)) && ((I(g) ? g > 0 : g.length) || !n), p = e || this.getExtremesFromAll || this.options.getExtremesFromAll || this.cropped || !i || (C[f + o] || u) >= b && (C[f - o] || u) <= v, c && p) {
                            if (m = g.length) for (; m--;) I(g[m]) && (r[k++] = g[m]); else r[k++] = g
                        }
                    ...
                    translate() {
                        ...
                        let t = this.options, e = t.stacking, i = this.xAxis, s = i.categories,
                            r = this.enabledDataSorting, o = this.yAxis, n = this.points, a = n.length,
                            l = this.pointPlacementToXValue(), h = !!l, d = t.threshold,
                            c = t.startFromThreshold ? d : 0, p, u, g, f, m = Number.MAX_VALUE;
                        ...
                        for (p = 0; p < a; p++) {
                            let t;
                            let a = n[p], y = a.x, b, k, C = a.y, M = a.low,
                    ...
                    getValidPoints(t, e, i) {
                        ...
                        return (t || this.points || []).filter(function (t) {
                            ...
                            return !!((i || !t.isNull && I(o)) && (!e || s.isInsidePlot(r, o, {inverted: s.inverted}))) && !1 !== t.visible
                        })
                    }

                    getClipBox() {
                        let {chart: t, xAxis: e, yAxis: i} = this, {x: s, y: r, width: o, height: n} = R(t.clipBox);
                    ...
                    setClip() {
                        let {chart: t, group: e, markerGroup: i} = this, s = t.sharedClips, r = t.renderer,
                            o = this.getClipBox(), n = this.getSharedClipKey(), a = s[n];
                        a ? a.animate(o) : s[n] = a = r.clipRect(o), e && e.clip(!1 === this.options.clip ? void 0 : a), i && i.clip()
                    }

                    animate(t) {
                        let {chart: e, group: i, markerGroup: s} = this, r = e.inverted, o = d(this.options.animation),
                            n = [this.getSharedClipKey(), o.duration, o.easing, o.defer].join(","),
                            a = e.sharedClips[n], l = e.sharedClips[n + "m"];
                        if (t && i) {
                            ...
                            let t = this.getClipBox(), i = o.step;
                    ...
                    drawPoints(t = this.points) {
                        ...
                        if (!1 !== p.enabled || this._hasPointMarkers) for (e = 0; e < t.length; e++) if (r = (s = (i = t[e]).graphic) ? "animate" : "attr", o = i.marker || {}, n = !!i.marker, (f && void 0 === o.enabled || o.enabled) && !i.isNull && !1 !== i.visible) {
                            ...
                            let e = !1 !== i.isInside;
                            if (!s && e && ((a.width || 0) > 0 || i.hasImage) && (i.graphic = s = l.renderer.symbol(t, a.x, a.y, a.width, a.height, n ? o : p).add(u), this.enabledDataSorting && l.hasRendered && (s.attr({x: i.startXPos}), r = "animate")), s && "animate" === r && s[e ? "show" : "hide"](e).animate(a), s) {
                    ...
                    markerAttribs(t, e) {
                        let i = this.options, s = i.marker, r = t.marker || {}, o = r.symbol || s.symbol, n = {}, a, l,
                            h = N(r.radius, s && s.radius);
                    ...
                    pointAttribs(t, e) {
                        let i = this.options.marker, s = t && t.options, r = s && s.marker || {}, o = s && s.color,
                            n = t && t.color, a = t && t.zone && t.zone.color, l, h, d = this.color, c, p,
                            u = N(r.lineWidth, i.lineWidth), g = 1;
                    ...
                    destroy(t) {
                        let e, i, s;
                        let r = this, o = r.chart, n = /AppleWebKit\/533/.test(f.navigator.userAgent), a = r.data || [];
                        for (L(r, "destroy", {keepEventsForUpdate: t}), this.removeEvents(t), (r.axisTypes || []).forEach(function (t) {
                    ...
                    applyZones() {
                        let {
                            ...
                            yAxis: n,
                            zoneAxis: a
                        } = this, {inverted: l, renderer: h} = e, d = this[`${a}Axis`], {
                            isXAxis: c,
                            len: p = 0
                        } = d || {}, u = (i?.strokeWidth() || 0) / 2 + 1, g = (t, e = 0, i = 0) => {
                            l && (i = p - i);
                            let {translated: s = 0, lineClip: r} = t, o = i - s;
                        ...
                        if (s.length && (i || t) && d && I(d.min)) {
                            ...
                            if (s.forEach(t => {
                                ...
                                let {plotX: e, plotY: i, zone: r} = t, o = r && s[s.indexOf(r) - 1];
                                r && g(r, e, i), o && g(o, e, i)
                            }
                            let f = [], m = d.toPixels(d.getExtremes().min, !0);
                            s.forEach(e => {
                                let s = e.lineClip || [], r = Math.round(e.translated || 0);
                                o.reversed && s.reverse();
                                let {clip: a, simpleClip: d} = e, p = 0, g = 0, x = o.len, y = n.len;
                                c ? (p = r, x = m) : (g = r, y = m);
                                let b = [["M", p, g], ["L", x, g], ["L", x, y], ["L", p, y], ["Z"]],
                                    v = [b[0], ...s, b[1], b[2], ...f, b[3], b[4]];
                                f = s.reverse(), m = r, l && (u(v), t && u(b)), a ? (a.animate({d: v}), d?.animate({d: b})) : (a = e.clip = h.path(v), t && (d = e.simpleClip = h.path(b))), i && e.graph?.clip(a), t && e.area?.clip(d)
                            })
                        } else this.visible && (i && i.show(), t && t.show())
                    }

                    plotGroup(t, e, i, s, r) {
                        let o = this[t], n = !o, a = {visibility: i, zIndex: s || .1};
                    ...
                    render() {
                        let t = this, {chart: e, options: i, hasRendered: s} = t, r = d(i.animation),
                            o = t.visible ? "inherit" : "hidden", n = i.zIndex, a = e.seriesGroup,
                    ...
                    searchKDTree(t, e, i) {
                        let s = this, [r, o] = this.kdAxisArray, n = e ? "distX" : "dist",
                            a = (s.options.findNearestPointBy || "").indexOf("y") > -1 ? 2 : 1, l = !!s.isBubble;
                        if (this.kdTree || this.buildingKdTree || this.buildKDTree(i), this.kdTree) return function t(e, i, a, h) {
                            var d;
                            let c, p, u, g, f, m, x, y = i.point, b = s.kdAxisArray[a % h], v, k, C = y;
                            d = y, c = e[r], p = d[r], u = S(c) && S(p) ? c - p : null, g = e[o], f = d[o], m = S(g) && S(f) ? g - f : 0, x = l && d.marker?.radius || 0, d.dist = Math.sqrt((u && u * u || 0) + m * m) - x, d.distX = S(u) ? Math.abs(u) - x : Number.MAX_VALUE;
                            let M = (e[b] || 0) - (y[b] || 0) + (l && y.marker?.radius || 0),
                                w = M < 0 ? "left" : "right", A = M < 0 ? "right" : "left";
                            return i[w] && (C = (v = t(e, i[w], a + 1, h))[n] < C[n] ? v : y), i[A] && Math.sqrt(M * M) < C[n] && (C = (k = t(e, i[A], a + 1, h))[n] < C[n] ? k : C), C
                        }(t, this.kdTree, a, a)
                    }
                    ...
                    drawTracker() {
                        let t = this, e = t.options, i = e.trackByArea,
                            s = [].concat((i ? t.areaPath : t.graphPath) || []), r = t.chart, o = r.pointer,
                            n = r.renderer, a = r.options.tooltip?.snap || 0, l = () => {
                        ...
                        d ? d.attr({d: s}) : t.graph && (t.tracker = d = n.path(s).attr({
                            ...
                            }), e.cursor && !r.styledMode && t.css({cursor: e.cursor}), t.on("touchstart", l))
                        })), L(this, "afterDrawTracker")
                    }

                    addPoint(t, e, i, s, r) {
                        let o, n;
                        let a = this.options, l = this.data, h = this.chart, d = this.xAxis,
                            c = d && d.hasNames && d.names, p = a.data, u = this.xData;
                        e = N(e, !0);
                        let g = {series: this};
                        this.pointClass.prototype.applyOptions.apply(g, [t]);
                        let f = g.x;
                        if (n = u.length, this.requireSorting && f < u[n - 1]) for (o = !0; n && u[n - 1] > f;) n--;
                        this.updateParallelArrays(g, "splice", [n, 0, 0]), this.updateParallelArrays(g, n), c && g.name && (c[f] = g.name), p.splice(n, 0, t), (o || this.processedData) && (this.data.splice(n, 0, null), this.processData()), "point" === a.legendType && this.generatePoints(), i && (l[0] && l[0].remove ? l[0].remove(!1) : (l.shift(), this.updateParallelArrays(g, "shift"), p.shift())), !1 !== r && L(this, "addPoint", {point: g}), this.isDirty = !0, this.isDirtyData = !0, e && h.redraw(s)
                    }

                    removePoint(t, e, i) {
                        let s = this, r = s.data, o = r[t], n = s.points, a = s.chart, l = function () {
                            n && n.length === r.length && n.splice(t, 1), r.splice(t, 1), s.options.data.splice(t, 1), s.updateParallelArrays(o || {series: s}, "splice", [t, 1]), o && o.destroy(), s.isDirty = !0, s.isDirtyData = !0, e && a.redraw()
                        };
                    ...
                    update(t, e) {
                        ...
                        let i = this, s = i.chart, r = i.userOptions, o = i.initialType || i.type,
                            n = s.options.plotOptions, a = m[o].prototype, l = i.finishedAnimating && {animation: !1},
                            h = {}, d, c,
                        ...
                        if (p.forEach(function (t) {
                            i[t] = p[t]
                        }), i.init(s, t), g && this.points) for (let t of (!1 === (d = i.options).visible ? (h.graphic = 1, h.dataLabel = 1) : (this.hasMarkerChanged(d, r) && (h.graphic = 1), i.hasDataLabels?.() || (h.dataLabel = 1)), this.points)) t && t.series && (t.resolveColor(), Object.keys(h).length && t.destroyElements(h), !1 === d.showInLegend && t.legendItem && s.legend.destroyItem(t));
                    ...
                    hasOptionChanged(t) {
                        let e = this.chart, i = this.options[t], s = e.options.plotOptions, r = this.userOptions[t],
                    ...
                    setState(t, e) {
                        let i = this, s = i.options, r = i.graph, o = s.inactiveOtherPoints, n = s.states,
                        ...
                        if (t = t || "", i.state !== t && ([i.group, i.markerGroup, i.dataLabelsGroup].forEach(function (e) {
                            ...
                            if (t && (l = n[t].lineWidth || l + (n[t].lineWidthPlus || 0), h = N(n[t].opacity, h)), r && !r.dashstyle && I(l)) for (let t of [r, ...this.zones.map(t => t.graph)]) t?.animate({"stroke-width": l}, a);
                ...
                class O {
                    ...
                    update(t, e) {
                        let i = this.chart;
                        this.setOptions(M(!0, this.options, t)), "events" in this.options && c(this, this.options), this.destroy(), i.isDirtyLegend = i.isDirtyBox = !0, w(e, !0) && i.redraw(), S(this, "afterUpdate", {redraw: e})
                    }
                    ...
                    colorizeItem(t, e) {
                        ...
                        if (s?.[e ? "removeClass" : "addClass"]("highcharts-legend-item-hidden"), !this.chart.styledMode) {
                            ...
                            r?.css(M(e ? this.itemStyle : s)), o?.attr(p({stroke: d || t.color})), n && n.attr(p(c && n.isMarker ? t.pointAttribs() : {fill: t.color})), i?.attr(p({
                                fill: l || t.color,
                    ...
                    positionItem(t) {
                        let {group: e, x: i = 0, y: s = 0} = t.legendItem || {}, r = this.options, o = r.symbolPadding,
                            n = !r.rtl, a = t.checkbox;
                        if (e && e.element) {
                            let r = {translateX: n ? i : this.legendWidth - i - 2 * o - 4, translateY: s};
                    ...
                    renderItem(t) {
                        let e = t.legendItem = t.legendItem || {}, i = this.chart, s = i.renderer, r = this.options,
                            o = "horizontal" === r.layout, n = this.symbolWidth, a = r.symbolPadding || 0,
                            l = this.itemStyle, h = this.itemHiddenStyle, d = o ? w(r.itemDistance, 20) : 0, c = !r.rtl,
                            p = !t.series, u = !p && t.series.drawLegendSymbol ? t.series : t, g = u.options,
                            f = !!this.createCheckboxForItem && g && g.showCheckbox, m = r.useHTML,
                            x = t.options.className, y = e.label, b = n + a + d + (f ? 20 : 0);
                        !y && (e.group = s.g("legend-item").addClass("highcharts-" + u.type + "-series highcharts-color-" + t.colorIndex + (x ? " " + x : "") + (p ? " highcharts-series-" + t.index : "")).attr({zIndex: 1}).add(this.scrollGroup), e.label = y = s.text("", c ? n + a : -a, this.baseline || 0, m), i.styledMode || y.css(M(t.visible ? l : h)), y.attr({
                            align: c ? "left" : "right",
                            zIndex: 2
                        ...
                        t.itemWidth = t.checkboxOffset = r.itemWidth || e.labelWidth || v.width + b, this.maxItemWidth = Math.max(this.maxItemWidth, t.itemWidth), this.totalItemWidth += t.itemWidth, this.itemHeight = t.itemHeight = Math.round(e.labelHeight || (v.height > 1.5 * k ? v.height : k))
                    }

                    layoutItem(t) {
                        let e = this.options, i = this.padding, s = "horizontal" === e.layout, r = t.itemHeight,
                            o = this.itemMarginBottom, n = this.itemMarginTop, a = s ? w(e.itemDistance, 20) : 0,
                    ...
                    proximatePositions() {
                        ...
                        for (let r of (this.allItems.forEach(function (t) {
                            let r, o, n = s, a, l;
                            t.yAxis && (t.xAxis.options.reversed && (n = !n), t.points && (r = k(n ? t.points : t.points.slice(0).reverse(), function (t) {
                                return C(t.plotY)
                    ...
                    render() {
                        ...
                        this.itemX = s, this.itemY = this.initialItemY, this.offsetWidth = 0, this.lastItemY = 0, this.widthOption = T(i.width, t.spacingBox.width - s), h = t.spacingBox.width - 2 * s - i.x, ["rm", "lm"].indexOf(this.getAlignment().substring(0, 2)) > -1 && (h /= 2), this.maxLegendWidth = this.widthOption || h, l || (this.group = l = e.g("legend").addClass(i.className || "").attr({zIndex: 7}).add(), this.contentGroup = e.g().attr({zIndex: 1}).add(l), this.scrollGroup = e.g().add(this.contentGroup)), this.renderTitle(), P(r, (t, e) => (t.options && t.options.legendIndex || 0) - (e.options && e.options.legendIndex || 0)), i.reversed && r.reverse(), this.allItems = r, this.display = o = !!r.length, this.lastLineHeight = 0, this.maxItemWidth = 0, this.totalItemWidth = 0, this.itemHeight = 0, r.forEach(this.renderItem, this), r.forEach(this.layoutItem, this), n = (this.widthOption || this.offsetWidth) + s, a = this.lastItemY + this.lastLineHeight + this.titleHeight, a = this.handleOverflow(a) + s, d || (this.box = d = e.rect().addClass("highcharts-legend-box").attr({r: i.borderRadius}).add(l)), t.styledMode || d.attr({
                            ...
                            width: n,
                            height: a
                        }, d.strokeWidth())), l[o ? "show" : "hide"](), t.styledMode && "none" === l.getStyle("display") && (n = a = 0), this.legendWidth = n, this.legendHeight = a, o && this.align(), this.proximate || this.positionItems(), S(this, "afterRender")
                    }

                    align(t = this.chart.spacingBox) {
                        let e = this.chart, i = this.options, s = t.y;
                        /(lth|ct|rth)/.test(this.getAlignment()) && e.titleOffset[0] > 0 ? s += e.titleOffset[0] : /(lbh|cb|rbh)/.test(this.getAlignment()) && e.titleOffset[2] > 0 && (s -= e.titleOffset[2]), s !== t.y && (t = M(t, {y: s})), e.hasRendered || (this.group.placed = !1), this.group.align(M(i, {
                    ...
                    handleOverflow(t) {
                        let e = this, i = this.chart, s = i.renderer, r = this.options, o = r.y,
                            n = "top" === r.verticalAlign, a = this.padding, l = r.maxHeight, h = r.navigation,
                            d = w(h.animation, !0), c = h.arrowSize || 12, p = this.pages, u = this.allItems,
                            g = function (t) {
                                "number" == typeof t ? k.attr({height: t}) : k && (e.clipRect = k.destroy(), e.contentGroup.clip()), e.contentGroup.div && (e.contentGroup.div.style.clip = t ? "rect(" + a + "px,9999px," + (a + t) + "px,0)" : "auto")
                            }, f = function (t) {
                                return e[t] = s.circle(0, 0, 1.3 * c).translate(c / 2, c / 2).add(v), i.styledMode || e[t].attr("fill", "rgba(0,0,0,0.0001)"), e[t]
                            }, m, x, y, b = i.spacingBox.height + (n ? -o : o) - a, v = this.nav, k = this.clipRect;
                        return "horizontal" !== r.layout || "middle" === r.verticalAlign || r.floating || (b /= 2), l && (b = Math.min(b, l)), p.length = 0, t && b > 0 && t > b && !1 !== h.enabled ? (this.clipHeight = m = Math.max(b - 20 - this.titleHeight - a, 0), this.currentPage = w(this.currentPage, 1), this.fullHeight = t, u.forEach((t, e) => {
                            let i = (y = t.legendItem || {}).y || 0, s = Math.round(y.label.getBBox().height),
                                r = p.length;
                        ...
                        }), k || (k = e.clipRect = s.clipRect(0, a - 2, 9999, 0), e.contentGroup.clip(k)), g(m), v || (this.nav = v = s.g().attr({zIndex: 1}).add(this.group), this.up = s.symbol("triangle", 0, 0, c, c).add(v), f("upTracker").on("click", function () {
                            e.scroll(-1, d)
                    ...
                    scroll(t, e) {
                        let i = this.chart, s = this.pages, r = s.length, o = this.clipHeight,
                            n = this.options.navigation, a = this.pager, l = this.padding, c = this.currentPage + t;
                        ...
                        }), a.attr({text: c + "/" + r}), [this.down, this.downTracker].forEach(function (t) {
                            t.attr({
                                x: 18 + this.pager.getBBox().width,
                                class: c === r ? "highcharts-legend-nav-inactive" : "highcharts-legend-nav-active"
                            })
                        }, this), i.styledMode || (this.up.attr({fill: 1 === c ? n.inactiveColor : n.activeColor}), this.upTracker.css({cursor: 1 === c ? "default" : "pointer"}), this.down.attr({fill: c === r ? n.inactiveColor : n.activeColor}), this.downTracker.css({cursor: c === r ? "default" : "pointer"})), this.scrollOffset = -s[c - 1] + this.initialItemY, this.scrollGroup.animate({translateY: this.scrollOffset}), this.currentPage = c, this.positionCheckboxes(), L(() => {
                            S(this, "afterScroll", {currentPage: c})
                        }, h(w(e, i.renderer.globalAnimation, !0)).duration))
                    }

                    setItemEvents(t, e, i) {
                        let o = this, n = t.legendItem || {}, a = o.chart.renderer.boxWrapper, l = t instanceof r,
                            h = t instanceof s, d = "highcharts-legend-" + (l ? "point" : "series") + "-active",
                            c = o.chart.styledMode, p = i ? [e, n.symbol] : [n.group], u = e => {
                        ...
                        for (let i of p) i && i.on("mouseover", function () {
                            ...
                            a.removeClass(d), S(o, "itemClick", {
                                browserEvent: e,
                                legendItem: t
                            }, i), l ? t.firePointEvent("legendItemClick", {browserEvent: e}) : h && S(t, "legendItemClick", {browserEvent: e})
                        })
                    }
                    ...
                    createCheckboxForItem(t) {
                        t.checkbox = x("input", {
                            ...
                            let i = e.target;
                            S(t.series || t, "checkboxClick", {checked: i.checked, item: t}, function () {
                                t.select()
                            })
                        })
                    }
                ...
                return (l = O || (O = {})).compose = function (t) {
                ...
                let {animate: g, animObject: f, setAnimation: m} = t, {
                    defaultOptions: x,
                    defaultTime: y
                } = i, {numberFormat: b} = s, {registerEventOptions: v} = r, {
                    charts: k,
                    doc: S,
                    marginNames: C,
                    svg: M,
                ...
                class Q {
                    ...
                    initSeries(t) {
                        let e = this.options.chart, i = t.type || e.type, s = A[i];
                    ...
                    orderItems(t, e = 0) {
                        let i = this[t], s = this.options[t] = Z(this.options[t]).slice(),
                    ...
                    isInsidePlot(t, e, i = {}) {
                        let {
                            ...
                            c = i.visiblePlotOnly && a || r, p = i.inverted ? e : t, u = i.inverted ? t : e,
                            g = {x: p, y: u, isInsidePlot: !0, options: i};
                        if (!i.ignoreX) {
                            let t = d && (s && !this.polar ? d.yAxis : d.xAxis) || {pos: o, len: 1 / 0},
                    ...
                    redraw(t) {
                        N(this, "beforeRedraw");
                        let e = this.hasCartesianSeries ? this.axes : this.colorAxis || [], i = this.series,
                            s = this.pointer, r = this.legend, o = this.userOptions.legend, n = this.renderer,
                            a = n.isHidden(), l = [], h, d, c, p = this.isDirtyBox, u = this.isDirtyLegend, g;
                    ...
                    getAxes() {
                        ...
                        for (let i of (N(this, "getAxes"), ["xAxis", "yAxis"])) for (let s of t[i] = Z(t[i] || {})) new e(this, s, i);
                        N(this, "afterGetAxes")
                    }
                    ...
                    applyDescription(t, e) {
                        let i = this, s = this.options[t] = Y(this.options[t], e), r = this[t];
                        ...
                        }, this.styledMode || r.css(R("title" === t ? {fontSize: this.options.isStock ? "1em" : "1.2em"} : {}, s.style)), this[t] = r)
                    }

                    layOutTitles(t = !0) {
                        let e = [0, 0, 0], i = this.renderer, s = this.spacingBox;
                        ["title", "subtitle", "caption"].forEach(function (t) {
                            let r = this[t], o = this.options[t], n = o.verticalAlign || "top",
                                a = "title" === t ? "top" === n ? -3 : 0 : "top" === n ? e[0] + 2 : 0;
                            if (r) {
                                r.css({width: (o.width || s.width + (o.widthAdjust || 0)) + "px"});
                                let t = i.fontMetrics(r).b, l = Math.round(r.getBBox(o.useHTML).height);
                                r.align(R({
                                    y: "bottom" === n ? t : a + t,
                                    height: l
                    ...
                    temporaryDisplay(t) {
                        ...
                        if (t) for (; e && e.style;) e.hcOrigStyle && (O(e, e.hcOrigStyle), delete e.hcOrigStyle), e.hcOrigDetached && (S.body.removeChild(e), e.hcOrigDetached = !1), e = e.parentNode; else for (; e && e.style && (S.body.contains(e) || e.parentNode || (e.hcOrigDetached = !0, S.body.appendChild(e)), ("none" === W(e, "display", !1) || e.hcOricDetached) && (e.hcOrigStyle = {
                    ...
                    getContainer() {
                        ...
                        O(o, {overflow: "hidden"}), this.styledMode || (r = R({
                            position: "relative",
                            overflow: "hidden",
                            width: d + "px",
                            height: l + "px",
                        ...
                        this.container = c, this.getChartSize(), d === this.chartWidth || (d = this.chartWidth, this.styledMode || O(c, {width: V(e.style?.width, d + "px")})), this.containerBox = this.getContainerBox(), this._cursor = c.style.cursor;
                    ...
                    getAxisMargins() {
                        let t = this, e = t.axisOffset = [0, 0, 0, 0], i = t.colorAxis, s = t.margin, r = function (t) {
                            t.forEach(function (t) {
                    ...
                    setSize(t, e, i) {
                        ...
                        let {chartWidth: n, chartHeight: a, scrollablePixelsX: l = 0, scrollablePixelsY: h = 0} = s;
                    ...
                    setChartSize(t) {
                        let e, i, s, r;
                        let {chartHeight: o, chartWidth: n, inverted: a, spacing: l, renderer: h} = this,
                            d = this.clipOffset, c = Math[a ? "floor" : "round"];
                        ...
                        }), h.alignElements()), N(this, "afterSetChartSize", {skipAxes: t})
                    }
                    ...
                    drawChartBox() {
                        let t = this.options.chart, e = this.renderer, i = this.chartWidth, s = this.chartHeight,
                            r = this.styledMode, o = this.plotBGImage, n = t.backgroundColor, a = t.plotBackgroundColor,
                            ...
                            m = this.chartBackground, x = this.plotBackground, y = this.plotBorder, b, v, k,
                            S = "animate";
                        m || (this.chartBackground = m = e.rect().addClass("highcharts-background").add(), S = "attr"), r ? b = v = m.strokeWidth() : (v = (b = t.borderWidth || 0) + (t.shadow ? 8 : 0), k = {fill: n || "none"}, (b || m["stroke-width"]) && (k.stroke = t.borderColor, k["stroke-width"] = b), m.attr(k).shadow(t.shadow)), m[S]({
                            x: v / 2,
                            y: v / 2,
                            width: i - v - b % 2,
                            height: s - v - b % 2,
                            r: t.borderRadius
                        }), S = "animate", x || (S = "attr", this.plotBackground = x = e.rect().addClass("highcharts-plot-background").add()), x[S](u), !r && (x.attr({fill: a || "none"}).shadow(t.plotShadow), l && (o ? (l !== o.attr("href") && o.attr("href", l), o.animate(u)) : this.plotBGImage = e.image(l, h, d, c, p).add())), g ? g.animate({
                            width: f.width,
                            height: f.height
                        }) : this.clipRect = e.clipRect(f), S = "animate", y || (S = "attr", this.plotBorder = y = e.rect().addClass("highcharts-plot-border").attr({zIndex: 1}).add()), r || y.attr({
                    ...
                    propFromSeries() {
                        let t, e, i;
                        let s = this, r = s.options.chart, o = s.options.series;
                    ...
                    render() {
                        let t = this.axes, e = this.colorAxis, i = this.renderer,
                            s = this.options.chart.axisLayoutRuns || 2, r = t => {
                                t.forEach(t => {
                                    t.visible && t.render()
                                })
                            }, o = 0, n = !0, a, l = 0;
                        for (let e of (this.setTitle(), N(this, "beforeMargins"), this.getStacks?.(), this.getMargins(!0), this.setChartSize(), t)) {
                            ...
                            if (this.hasCartesianSeries && e.horiz && e.visible && i.enabled && e.series.length && "colorAxis" !== e.coll && !this.polar) {
                                ...
                                let s = new u(e, 0, "", !0), r = s.createLabel("x", i);
                    ...
                    addCredits(t) {
                        let e = this, i = Y(!0, this.options.credits, t);
                    ...
                    destroy() {
                        let t;
                        let e = this, i = e.axes, s = e.series, r = e.container, n = r && r.parentNode;
                        for (N(e, "destroy"), e.renderer.forExport ? I(k, e) : k[e.index] = void 0, o.chartCount--, e.renderTo.removeAttribute("data-highcharts-chart"), _(e), t = i.length; t--;) i[t] = i[t].destroy();
                        ...
                        }), r && (r.innerHTML = p.emptyHTML, _(r), n && j(r)), U(e, function (t, i) {
                            delete e[i]
                        })
                    }
                    ...
                    addSeries(t, e, i) {
                        let s;
                        let r = this;
                        return t && (e = V(e, !0), N(r, "addSeries", {options: t}, function () {
                            s = r.initSeries(t), r.isDirtyLegend = !0, r.linkSeries(), s.enabledDataSorting && s.setData(t.data, !1), N(r, "afterAddSeries", {series: s}), e && r.redraw(i)
                        })), s
                    }
                    ...
                    showLoading(t) {
                        ...
                        o || (e.loadingDiv = o = L("div", {className: "highcharts-loading highcharts-loading-hidden"}, null, e.container)), n || (e.loadingSpan = n = L("span", {className: "highcharts-loading-inner"}, null, o), T(e, "redraw", r)), o.className = "highcharts-loading", p.setElementHTML(n, V(t, i.lang.loading, "")), e.styledMode || (O(o, R(s.style, {zIndex: 10})), O(n, s.labelStyle), e.loadingShown || (O(o, {
                            opacity: 0,
                            display: ""
                        }), g(o, {opacity: s.style.opacity || .5}, {duration: s.showDuration || 0}))), e.loadingShown = !0, r()
                    }
                    ...
                    update(t, e, i, s) {
                        ...
                        N(a, "update", {options: t}), h || a.setResponsive(!1, !0), t = D(t, a.options), a.userOptions = Y(a.userOptions, t);
                        let p = t.chart;
                        ...
                        let u = p && p.width, g = p && (F(p.height) ? q(p.height, u || a.chartWidth) : p.height);
                    ...
                    zoomOut() {
                        N(this, "selection", {resetSelection: !0}, () => this.transform({reset: !0, trigger: "zoom"}))
                    }

                    pan(t, e) {
                        let i = this, s = "object" == typeof e ? e : {enabled: e, type: "x"}, r = s.type, o = r && i[({
                            x: "xAxis",
                            xy: "axes",
                            y: "yAxis"
                        })[r]].filter(t => t.options.panningEnabled && !t.options.isInternal), n = i.options.chart;
                        n?.panning && (n.panning = s), N(this, "pan", {originalEvent: t}, () => {
                            i.transform({
                                axes: o,
                                event: t,
                    ...
                    transform(t) {
                        ...
                        for (let t of (this.hoverPoints?.forEach(t => t.setState()), e)) {
                            let {horiz: e, len: p, minPointOffset: u = 0, options: g, reversed: f} = t,
                                m = e ? "width" : "height", x = e ? "x" : "y", y = V(n[m], t.len), b = V(s[m], t.len),
                                v = 10 > Math.abs(y) ? 1 : y / b, k = (s[x] || 0) + b / 2 - t.pos,
                                S = k - ((n[x] ?? t.pos) + y / 2 - t.pos) / v, C = f && !l || !f && l ? -1 : 1;
                            if (!r && (k < 0 || k > t.len)) continue;
                            let M = t.toValue(S, !0) + (o ? 0 : u * C),
                                w = t.toValue(S + p / v, !0) - (o ? 0 : u * C || 0), A = t.allExtremes;
                            ...
                            let {dataMin: T, dataMax: P, min: L, max: O} = R(t.getExtremes(), A || {}), D = T ?? g.min,
                                j = P ?? g.max, I = w - M, B = t.categories ? 0 : Math.min(I, j - D),
                                z = D - B * (E(g.min) ? 0 : g.minPadding), N = j + B * (E(g.max) ? 0 : g.maxPadding),
                                W = t.allowZoomOutside || 1 === v || "zoom" !== a && v > 1,
                                G = Math.min(g.min ?? z, z, W ? L : z), X = Math.max(g.max ?? N, N, W ? O : N);
                            (!t.isOrdinal || 1 !== v || r) && (M < G && (M = G, v >= 1 && (w = M + I)), w > X && (w = X, v >= 1 && (M = w - I)), (r || t.series.length && (M !== L || w !== O) && M >= G && w <= X) && (o ? o[t.coll].push({
                                axis: t,
                                min: M,
                                max: w
                                ...
                                trigger: a,
                                scale: v
                            }), !r && (M > G || w < X) && "mousewheel" !== a && (d = !0)), h = !0), i && (this[e ? "mouseDownX" : "mouseDownY"] = i[e ? "chartX" : "chartY"]))
                        }
                        return h && (o ? N(this, "selection", o, () => {
                            delete t.selection, t.trigger = "zoom", this.transform(t)
                        }) : (!d || c || this.resetZoomButton ? !d && this.resetZoomButton && (this.resetZoomButton = this.resetZoomButton.destroy()) : this.showResetZoom(), this.redraw("zoom" === a && (this.options.chart.animation ?? this.pointCount < 100)))), h
                    }
                }
                ...
                class g {
                    ...
                    static afterSetSize(t, e) {
                        ...
                        if (!p.forExport && (o ? (t.scrollablePixelsX = i = Math.max(0, o - t.chartWidth), i && (t.scrollablePlotBox = d(t.plotBox), l.width = t.plotWidth += i, a[c ? "height" : "width"] += i, r = !0)) : n && (t.scrollablePixelsY = s = Math.max(0, n - t.chartHeight), h(s) && (t.scrollablePlotBox = d(t.plotBox), l.height = t.plotHeight += s, a[c ? "width" : "height"] += s, r = !1)), h(r) && !e.skipAxes)) for (let e of t.axes) e.horiz === r && (e.setAxisSize(), e.setAxisTranslation())
                    }

                    constructor(t) {
                        let e;
                        let s = t.options.chart, r = i.getRendererType(), o = s.scrollablePlotArea || {},
                        ...
                        let c = this.parentDiv = a("div", {className: "highcharts-scrolling-parent"}, {position: "relative"}, t.renderTo),
                            p = this.scrollingContainer = a("div", {className: "highcharts-scrolling"}, d, c),
                            u = this.innerContainer = a("div", {className: "highcharts-inner-container"}, void 0, p),
                            g = this.fixedDiv = a("div", {className: "highcharts-fixed"}, {
                                position: "absolute",
                                overflow: "hidden",
                                pointerEvents: "none",
                                zIndex: (s.style?.zIndex || 0) + 2,
                                top: 0
                            }, void 0, !0), f = this.fixedRenderer = new r(g, t.chartWidth, t.chartHeight, s.style);
                        this.mask = f.path().attr({
                            fill: s.backgroundColor || "#fff",
                            "fill-opacity": o.opacity ?? .85,
                            zIndex: -1
                        }).addClass("highcharts-scrollable-mask").add(), p.parentNode.insertBefore(g, p), l(t.renderTo, {overflow: "visible"}), n(t, "afterShowResetZoom", h), n(t, "afterApplyDrilldown", h), n(t, "afterLayOutTitles", h), n(p, "scroll", () => {
                    ...
                    applyFixed() {
                        ...
                        let k = u - o[0] - 1, S = p - o[3] - 1, C = u + c + o[2] + 1, M = p + g + o[1] + 1,
                            w = p + g - f, A = u + c - m, T = [["M", 0, 0]];
                        f ? T = [["M", 0, k], ["L", p - 1, k], ["L", p - 1, C], ["L", 0, C], ["Z"], ["M", w, k], ["L", n, k], ["L", n, C], ["L", w, C], ["Z"]] : m && (T = [["M", S, 0], ["L", S, u - 1], ["L", M, u - 1], ["L", M, 0], ["Z"], ["M", S, A], ["L", S, a], ["L", M, a], ["L", M, A], ["Z"]]), "adjustHeight" !== t.redrawTrigger && this.mask.attr({d: T})
                    }

                    moveFixedElements() {
                        let t;
                        let {container: e, inverted: i, scrollablePixelsX: s, scrollablePixelsY: r} = this.chart,
                            o = this.fixedRenderer, n = g.fixedSelectors;
                ...
                return class {
                    constructor(t, e, i, s, r) {
                        let o = t.chart.inverted, n = t.reversed;
                        this.axis = t;
                    ...
                    render(t) {
                        let e = this.axis.chart, i = this.options, r = i.format,
                            o = r ? s(r, this, e) : i.formatter.call(this);
                        if (this.label) this.label.attr({text: o, visibility: "hidden"}); else {
                            this.label = e.renderer.label(o, null, void 0, i.shape, void 0, void 0, i.useHTML, !1, "stack-labels");
                            let s = {r: i.borderRadius || 0, text: o, padding: l(i.padding, 5), visibility: "hidden"};
                    ...
                    setOffset(t, e, i, s, o, h) {
                        ...
                        if (p && m) {
                            ...
                            d.x = u.x || 0, d.y = u.y || 0;
                            let {x: o, y: n} = this.adjustStackPosition({labelBox: t, verticalAlign: x, textAlign: g});
                    ...
                    adjustStackPosition({labelBox: t, verticalAlign: e, textAlign: i}) {
                        let s = {bottom: 0, middle: 1, top: 2, right: 1, center: 0, left: -1}, r = s[e], o = s[i];
                        return {x: t.width / 2 + t.width / 2 * o, y: t.height / 2 * r}
                    }

                    getStackBox(t) {
                        let e = this.axis, i = e.chart, {
                                boxTop: s,
                                defaultX: r,
                                xOffset: o,
                                width: n,
                                boxBottom: h
                            } = t, d = e.stacking.usePercentage ? 100 : l(s, this.total, 0), c = e.toPixels(d),
                            p = t.xAxis || i.xAxis[0], u = l(r, p.translate(this.x)) + o,
                        ...
                        return f ? {
                            ...
                            width: g,
                            height: n
                        } : {x: u + p.transB - i.plotLeft, y: (m ? c - g : c) - i.plotTop, width: n, height: g}
                    }
                }
                ...
                var o;
                let {getDeferredAnimation: n} = t, {series: {prototype: a}} = i, {
                    addEvent: l,
                    correctFloat: h,
                    defined: d,
                    destroyObjectProperties: c,
                ...
                function k() {
                    let t;
                    let e = this, i = e.yAxis, s = e.stackKey || "", r = i.stacking.stacks, o = e.processedXData,
                        n = e.options.stacking, a = e[n + "Stacker"];
                    a && [s, "-" + s].forEach(i => {
                        let s = o.length, n, l, h;
                ...
                function M(t, e) {
                    ...
                    let x = this.processedXData, y = this.processedYData, b = [], v = y.length, k = this.options,
                        S = k.threshold || 0, C = k.startFromThreshold ? S : 0, M = k.stack,
                        w = e ? `${this.type},${f}` : this.stackKey || "", A = "-" + w, T = this.negStacks,
                        P = t.stacking, L = P.stacks, O = P.oldStacks;
                ...
                class w {
                    ...
                    buildStacks() {
                        let t, e;
                        let i = this.axis, s = i.series, r = "xAxis" === i.coll, o = i.options.reversedStacks,
                            n = s.length;
                ...
                return (o || (o = {})).compose = function (t, e, i) {
                    let s = e.prototype, r = i.prototype;
                ...
                class n extends t {
                    drawGraph() {
                        let t = this.options, e = (this.gappedPath || this.getGraphPath).call(this),
                            i = this.chart.styledMode;
                        [this, ...this.zones].forEach((s, n) => {
                            let a, l = s.graph, h = l ? "animate" : "attr", d = s.dashStyle || t.dashStyle;
                            l ? (l.endX = this.preventGraphAnimation ? null : e.xMap, l.animate({d: e})) : e.length && (s.graph = l = this.chart.renderer.path(e).addClass("highcharts-graph" + (n ? ` highcharts-zone-graph-${n - 1} ` : " ") + (n && s.className || "")).attr({zIndex: 1}).add(this.group)), l && !i && (a = {
                                stroke: !n && t.lineColor || s.color || this.color || "#cccccc",
                                "stroke-width": t.lineWidth || 0,
                                fill: this.fillGraph && this.color || "none"
                            }, d ? a.dashstyle = d : "square" !== t.linecap && (a["stroke-linecap"] = a["stroke-linejoin"] = "round"), l[h](a).shadow(n < 2 && t.shadow && r({filterUnits: "userSpaceOnUse"}, o(t.shadow) ? t.shadow : {}))), l && (l.startX = e.xMap, l.isArea = e.isArea)
                        })
                    }

                    getGraphPath(t, e, i) {
                        let r = this, o = r.options, n = [], a = [], l, h = o.step, d = (t = t || r.points).reversed;
                        return d && t.reverse(), (h = ({
                            ...
                            (d.leftCliff || f && f.rightCliff) && !i && (l = !0), m && !s(e) && c > 0 ? l = !o.connectNulls : m && !e ? l = !0 : (0 === c || l ? p = [["M", d.plotX, d.plotY]] : r.getPointSpline ? p = [r.getPointSpline(t, d, c)] : h ? (p = 1 === h ? [["L", f.plotX, g]] : 2 === h ? [["L", (f.plotX + u) / 2, f.plotY], ["L", (f.plotX + u) / 2, g]] : [["L", u, f.plotY]]).push(["L", u, g]) : p = [["L", u, g]], a.push(d.x), h && (a.push(d.x), 2 === h && a.push(d.x)), n.push.apply(n, p), l = !1)
                        }), n.xMap = a, r.graphPath = n, n
                    }
                }

                return n.defaultOptions = r(t.defaultOptions, {legendSymbol: "lineMarker"}), e.registerSeriesType("line", n), n
                ...
                let {seriesTypes: {line: s}} = e, {extend: r, merge: o, objectEach: n, pick: a} = i;
                ...
                class l extends s {
                    drawGraph() {
                        ...
                        [this, ...this.zones].forEach((i, s) => {
                            ...
                            n ? (n.endX = this.preventGraphAnimation ? null : t.xMap, n.animate({d: t})) : (r.zIndex = 0, (n = i.area = this.chart.renderer.path(t).addClass("highcharts-area" + (s ? ` highcharts-zone-area-${s - 1} ` : " ") + (s && i.className || "")).add(this.group)).isArea = !0), this.chart.styledMode || (r.fill = o || i.color || this.color, r["fill-opacity"] = o ? 1 : e.fillOpacity ?? .75, n.css({pointerEvents: this.stickyTracking ? "none" : "auto"})), n[a](r), n.startX = t.xMap, n.shiftUnit = e.step ? 2 : 1
                        })
                    }

                    getGraphPath(t) {
                        let e, i, r;
                        let o = s.prototype.getGraphPath, n = this.options, l = n.stacking, h = this.yAxis, d = [],
                            c = [], p = this.index, u = h.stacking.stacks[this.stackKey], g = n.threshold,
                            f = Math.round(h.getThreshold(n.threshold)), m = a(n.connectNulls, "percent" === l),
                            x = function (i, s, r) {
                                let o = t[i], n = l && u[o.x].points[p], a = o[r + "Null"] || 0,
                                    m = o[r + "Cliff"] || 0, x, y, b = !0;
                        ...
                        d.reversed = !0;
                        let b = o.call(this, d, !0, !0), v = b[0];
                        v && "M" === v[0] && (b[0] = ["L", v[1], v[2]]);
                        let k = y.concat(b);
                        k.length && k.push(["Z"]);
                        let S = o.call(this, c, !1, m);
                        return this.chart.series.length > 1 && l && c.some(t => t.isCliff) && (k.hasStackedCliffs = S.hasStackedCliffs = !0), k.xMap = y.xMap, this.areaPath = k, S
                    }

                    getStackPoints(t) {
                        let e = this, i = [], s = [], r = this.xAxis, o = this.yAxis,
                            l = o.stacking.stacks[this.stackKey], h = {}, d = o.series, c = d.length,
                            p = o.options.reversedStacks ? 1 : -1, u = d.indexOf(e);
                        if (t = t || this.points, this.options.stacking) {
                            ...
                            s.forEach(function (t, n) {
                                ...
                                if (h[t] && !h[t].isNull) i.push(h[t]), [-1, 1].forEach(function (i) {
                                    let r = 1 === i ? "rightNull" : "leftNull", o = l[s[n + i]], a = 0;
                                    if (o) {
                                        let i = u;
                                        for (; i >= 0 && i < c;) {
                                            let s = d[i].index;
                ...
                return l.defaultOptions = o(s.defaultOptions, t), r(l.prototype, {singleStacks: !1}), e.registerSeriesType("area", l), l
            }), i(e, "Series/Spline/SplineSeries.js", [e["Core/Series/SeriesRegistry.js"], e["Core/Utilities.js"]], function (t, e) {
                let {line: i} = t.seriesTypes, {merge: s, pick: r} = e;
                ...
                class o extends i {
                    getPointSpline(t, e, i) {
                        ...
                        if (p(d) && p(c)) {
                            let t = d.plotX || 0, i = d.plotY || 0, r = c.plotX || 0, p = c.plotY || 0, u = 0;
                ...
                let {area: s, area: {prototype: r}} = e.seriesTypes, {extend: o, merge: n} = i;
                ...
                let {animObject: a} = t, {parse: l} = e, {noop: h} = s, {
                    clamp: d,
                    crisp: c,
                    defined: p,
                    extend: u,
                ...
                class v extends r {
                    animate(t) {
                        let e, i;
                        let s = this, r = this.yAxis, o = r.pos, n = r.reversed, l = s.options, {
                            clipOffset: h,
                            inverted: c
                        } = this.chart, p = {}, g = c ? "translateX" : "translateY";
                        t && h ? (p.scaleY = .001, i = d(r.toPixels(l.threshold), o, o + r.len), c ? (i += n ? -Math.floor(h[0]) : Math.ceil(h[2]), p.translateX = i - r.len) : (i += n ? Math.ceil(h[0]) : -Math.floor(h[2]), p.translateY = i), s.clipBox && s.setClip(), s.group.attr(p)) : (e = Number(s.group.attr(g)), s.group.animate({scaleY: 1}, u(a(s.options.animation), {
                            step: function (t, i) {
                    ...
                    getColumnMetrics() {
                        let t = this, e = t.options, i = t.xAxis, s = t.yAxis, r = i.options.reversedStacks,
                            o = i.reversed && !r || !i.reversed && r, n = {}, a, l = 0;
                        !1 === e.grouping ? l = 1 : t.chart.series.forEach(function (e) {
                            let i;
                            let r = e.yAxis, o = e.options;
                    ...
                    adjustForMissingColumns(t, e, i, s) {
                        if (!i.isNull && s.columnCount > 1) {
                            let r = this.xAxis.series.filter(t => t.visible).map(t => t.index), o = 0, n = 0;
                    ...
                    translate() {
                        let t = this, e = t.chart, i = t.options,
                            s = t.dense = t.closestPointRange * t.xAxis.transA < 2,
                            o = t.borderWidth = y(i.borderWidth, s ? 0 : 1), n = t.xAxis, a = t.yAxis, l = i.threshold,
                            h = y(i.minPointLength, 5), c = t.getColumnMetrics(), u = c.width,
                            f = t.pointXOffset = c.offset, x = t.dataMin, b = t.dataMax,
                            v = t.translatedThreshold = a.getThreshold(l), k = t.barW = Math.max(u, 1 + 2 * o);
                        i.pointPadding && (k = Math.ceil(k)), r.prototype.translate.apply(t), t.points.forEach(function (s) {
                            let r = y(s.yBottom, v), o = 999 + Math.abs(r), g = s.plotX || 0,
                                S = d(s.plotY, -o, a.len + o), C, M = Math.min(S, r), w = Math.max(S, r) - M, A = u,
                                T = g + f, P = k;
                    ...
                    pointAttribs(t, e) {
                        let i = this.options, s = this.pointAttrToOptions || {}, r = s.stroke || "borderColor",
                            o = s["stroke-width"] || "borderWidth", n, a, h, d = t && t.color || this.color,
                            c = t && t[r] || i[r] || d, p = t && t.options.dashStyle || i.dashStyle,
                            u = t && t[o] || i[o] || this[o] || 0, g = y(t && t.opacity, i.opacity, 1);
                    ...
                    drawTracker(t = this.points) {
                        ...
                        t.forEach(function (t) {
                            ...
                            }).on("touchstart", o), !s.styledMode && i.options.cursor && i[t].css({cursor: i.options.cursor}))
                ...
                var s;
                let {getDeferredAnimation: r} = t, {format: o} = e, {
                    defined: n,
                    extend: a,
                    fireEvent: l,
                    isArray: h,
                ...
                return function (t) {
                    ...
                    function i(t, e, i, s, r) {
                        let {chart: o, enabledDataSorting: l} = this, h = this.isCartesian && o.inverted, d = t.plotX,
                            p = t.plotY, g = i.rotation || 0, f = n(d) && n(p) && o.isInsidePlot(d, Math.round(p), {
                                inverted: h,
                                paneCoordinates: !0,
                                series: this
                            }), m = 0 === g && "justify" === u(i.overflow, l ? "none" : "justify"),
                            x = this.visible && !1 !== t.visible && n(d) && (t.series.forceDL || l && !m || f || u(i.inside, !!this.options.stacking) && s && o.isInsidePlot(d, h ? s.x + 1 : s.y + s.height - 1, {
                                inverted: h,
                                paneCoordinates: !0,
                                series: this
                            })), y = t.pos();
                        if (x && y) {
                            var b;
                            let n = e.getBBox(), d = e.getBBox(void 0, 0),
                                p = {right: 1, center: .5}[i.align || 0] || 0,
                            ...
                            i.shape && !g && e[r ? "attr" : "animate"]({anchorX: y[0], anchorY: y[1]})
                        }
                    ...
                    function x(t) {
                        let e;
                        t = t || this.points;
                        let i = this, s = i.chart, a = i.options, h = s.renderer, {
                                backgroundColor: c,
                                plotBackgroundColor: m
                            } = s.options.chart, x = h.getContrast(d(m) && m || d(c) && c || "#000000"),
                            y = v(i), {animation: k, defer: S} = y[0], C = S ? r(s, k, i) : {defer: 0, duration: 0};
                    ...
                    function y(t, e, i, s, r, o) {
                        let n = this.chart, a = e.align, l = e.verticalAlign, h = t.box ? 0 : t.padding || 0,
                            d = n.inverted ? this.yAxis : this.xAxis, c = d ? d.left - n.plotLeft : 0,
                            p = n.inverted ? this.xAxis : this.yAxis, u = p ? p.top - n.plotTop : 0, {
                                x: g = 0,
                                y: f = 0
                            } = e, m, x;
                    ...
                    function k(t, e, i, s, r) {
                        let o = this.chart, n = o.inverted, a = this.xAxis, l = a.reversed,
                            h = ((n ? e.height : e.width) || 0) / 2, d = t.pointWidth, c = d ? d / 2 : 0;
                        e.startXPos = n ? r.x : l ? -h - c : a.width - h + c, e.startYPos = n ? l ? this.yAxis.height - h + c : -h - c : r.y, s ? "hidden" === e.visibility && (e.show(), e.attr({opacity: 0}).animate({opacity: 1})) : e.attr({opacity: 1}).animate({opacity: 0}, void 0, e.hide), o.hasRendered && (i && e.attr({
                            x: e.startXPos,
                            y: e.startYPos
                        }), e.placed = !0)
                    }
                ...
                var r;
                let {composed: o} = e, {series: n} = i, {merge: a, pick: l, pushUnique: h} = s;
                return function (e) {
                    function i(t, e, i, s, r) {
                        let o = this.chart.inverted, h = t.series,
                        ...
                        i.align = l(i.align, !o || g ? "center" : u ? "right" : "left"), i.verticalAlign = l(i.verticalAlign, o || g ? "middle" : u ? "top" : "bottom"), n.prototype.alignDataLabel.call(this, t, e, i, s, r), i.inside && t.contrastColor && e.css({color: t.contrastColor})
                    }
                ...
                return o.defaultOptions = r(t.defaultOptions, {}), s(o.prototype, {inverted: !0}), e.registerSeriesType("bar", o), o
                ...
                let {column: s, line: r} = e.seriesTypes, {addEvent: o, extend: n, merge: a} = i;
                    ...
                    applyJitter() {
                        ...
                        e && this.points.forEach(function (s, r) {
                            ["x", "y"].forEach(function (o, n) {
                                if (e[o] && !s.isNull) {
                                    let a = `plot${o.toUpperCase()}`, l = t[`${o}Axis`], h = e[o] * l.transA;
                                    if (l && !l.logarithmic) {
                                        let t, e = Math.max(0, (s[a] || 0) - h), d = Math.min(l.len, (s[a] || 0) + h);
                ...
                var s, r;
                let {deg2rad: o} = t, {fireEvent: n, isNumber: a, pick: l, relativeLength: h} = i;
                return (r = s || (s = {})).getCenter = function () {
                    let t = this.options, i = this.chart, s = 2 * (t.slicedOffset || 0), r = i.plotWidth - 2 * s,
                        o = i.plotHeight - 2 * s, d = t.center, c = Math.min(r, o), p = t.thickness, u, g = t.size,
                        f = t.innerSize || 0, m, x;
                ...
                return n(d.prototype, {
                    connectorShapes: {
                        fixedOffset: function (t, e, i) {
                            let s = e.breakAt, r = e.touchingSliceAt,
                            ...
                            let {breakAt: s, touchingSliceAt: r} = e, {series: o} = this, [n, a, l] = o.center,
                                d = l / 2, {plotLeft: c, plotWidth: p} = o.chart, u = "left" === t.alignment, {
                                    x: g,
                                    y: f
                                } = t, m = s.x;
                            if (i.crookDistance) {
                ...
                let {getStartAndEndRadians: h} = t, {noop: d} = i, {
                    clamp: c,
                    extend: p,
                    fireEvent: u,
                    merge: g,
                ...
                class m extends o {
                    ...
                    drawEmpty() {
                        let t, e;
                        let i = this.startAngleRad, s = this.endAngleRad, r = this.options;
                    ...
                    getX(t, e, i, s) {
                        let r = this.center, o = this.radii ? this.radii[i.index] || 0 : r[2] / 2,
                            n = s.dataLabelPosition, a = n?.distance || 0,
                    ...
                    translate(t) {
                        ...
                        let e = this.options, i = e.slicedOffset, s = h(e.startAngle, e.endAngle),
                            r = this.startAngleRad = s.start, o = (this.endAngleRad = s.end) - r, n = this.points,
                            a = e.ignoreHiddenPoint, l = n.length, d, c, p, g, f, m, x, y = 0;
                ...
                var o;
                let {composed: n, noop: a} = e, {distribute: l} = i, {series: h} = s, {
                    arrayMax: d,
                    clamp: c,
                    defined: p,
                    pick: u,
                ...
                return function (e) {
                    ...
                    function s(t, e) {
                        let {center: i, options: s} = this, r = i[2] / 2, o = t.angle || 0, n = Math.cos(o),
                            a = Math.sin(o), l = i[0] + n * r, h = i[1] + a * r,
                            d = Math.min((s.slicedOffset || 0) + (s.borderWidth || 0), e / 5);
                        return {
                            natural: {x: l + n * e, y: h + a * e},
                            computed: {},
                            alignment: e < 0 ? "center" : t.half ? "right" : "left",
                            connectorPosition: {breakAt: {x: l + n * d, y: h + a * d}, touchingSliceAt: {x: l, y: h}},
                            distance: e
                        }
                    }

                    function r() {
                        let t = this, e = t.points, i = t.chart, s = i.plotWidth, r = i.plotHeight, o = i.plotLeft,
                            n = Math.round(i.chartWidth / 3), a = t.center, c = a[2] / 2, g = a[1], m = [[], []],
                            x = [0, 0, 0, 0], y = t.dataLabelPositioners, b, v, k, S = 0;
                        t.visible && t.hasDataLabels?.() && (e.forEach(t => {
                            ...
                            (t.dataLabels || []).forEach((e, i) => {
                                let s = a[2] / 2, r = e.options, o = f(r?.distance || 0, s);
                                0 === i && m[t.half].push(t), !p(r?.style?.width) && e.getBBox().width > n && (e.css({width: Math.round(.7 * n) + "px"}), e.shortened = !0), e.dataLabelPosition = this.getDataLabelPosition(t, o), S = Math.max(S, o)
                            })
                        }), m.forEach((e, n) => {
                            let h = e.length, d = [], f, m, b = 0, C;
                            h && (t.sortByAngle(e, n - .5), S > 0 && (f = Math.max(0, g - c - S), m = Math.min(g + c + S, i.plotHeight), e.forEach(t => {
                                ...
                                (i.dataLabels || []).forEach(l => {
                                    let h = l.options || {}, g = i.distributeBox, f = l.dataLabelPosition,
                                        m = f?.natural.y || 0, b = h.connectorPadding || 0, S = l.lineHeight || 21,
                                        C = (S - l.getBBox().height) / 2, M = 0, w = m, A = "inherit";
                                    if (f) {
                                        if (d && p(g) && f.distance > 0 && (void 0 === g.pos ? A = "hidden" : (k = g.size, w = y.radialDistributionY(i, l))), h.justify) M = y.justify(i, l, c, a); else switch (h.alignTo) {
                                            case"connectors":
                                                M = y.alignToConnectors(e, n, s, o);
                                                break;
                                            case"plotEdges":
                                                M = y.alignToPlotEdges(l, n, s, o);
                                                break;
                                            default:
                                                M = y.radialDistributionX(t, i, w - C, m, l)
                                        }
                                        if (f.attribs = {
                                            visibility: A,
                                            align: f.alignment
                                            ...
                                            x: M + (h.x || 0) + (({
                                                left: b,
                                                right: -b
                                            })[f.alignment] || 0), y: w + (h.y || 0) - S / 2
                                        }, f.computed.x = M, f.computed.y = w - C, u(h.crop, !0)) {
                                            let t;
                                            M - (v = l.getBBox().width) < b && 1 === n ? (t = Math.round(v - M + b), x[3] = Math.max(t, x[3])) : M + v > s - b && 0 === n && (t = Math.round(M + v - s + b), x[1] = Math.max(t, x[1])), w - k / 2 < 0 ? x[0] = Math.max(Math.round(-w + k / 2), x[0]) : w + k / 2 > r && (x[2] = Math.max(Math.round(w + k / 2 - r), x[2])), f.sideOverflow = t
                                        }
                                    }
                                })
                            }))
                    ...
                    function m(t) {
                        let e = this.center, i = this.options, s = i.center, r = i.minSize || 80, o = r,
                            n = null !== i.size;
                ...
                let {pointInPolygon: i} = t, {addEvent: s, fireEvent: r, objectEach: o, pick: n} = e;

                function a(t) {
                    let e = t.length, s = (t, e) => {
                    ...
                    for (let i = 0; i < e; ++i) {
                        h = (n = t[i]) && n.absoluteBox;
                        let r = h?.polygon;
                        for (let o = i + 1; o < e; ++o) {
                            d = (a = t[o]) && a.absoluteBox;
                            let e = !1;
                            if (h && d && n !== a && 0 !== n.newOpacity && 0 !== a.newOpacity && "hidden" !== n.visibility && "hidden" !== a.visibility) {
                                let t = d.polygon;
                                if (r && t && r !== t ? s(r, t) && (e = !0) : d.x >= h.x + h.width || d.x + d.width <= h.x || d.y >= h.y + h.height || d.y + d.height <= h.y || (e = !0), e) {
                                    let t = n.labelrank < a.labelrank ? n : a, e = t.text;
                                    t.newOpacity = 0, e?.element.querySelector("textPath") && e.hide()
                                }
                            }
                        }
                    }
                    for (let e of t) l(e, this) && (c = !0);
                    c && r(this, "afterHideAllOverlappingLabels")
                }
                ...
                function l(t, e) {
                    ...
                    }), r(e, "afterHideOverlappingLabel")) : t.attr({opacity: i})), t.isOld = !0), s
                }
                    ...
                    for (let i of t.series || []) if (i.visible && i.hasDataLabels?.()) {
                        let s = i => {
                            for (let s of i) s.visible && (s.dataLabels || []).forEach(i => {
                                let r = i.options || {};
                                i.labelrank = n(r.labelrank, s.labelrank, s.shapeArgs?.height), r.allowOverlap ?? Number(r.distance) > 0 ? (i.oldOpacity = i.opacity, i.newOpacity = 1, l(i, t)) : e.push(i)
                            })
                        };
                ...
                return {
                    compose: function (t) {
                        let e = t.prototype;
                        e.hideOverlappingLabels || (e.hideOverlappingLabels = a, s(t, "render", h))
                    }
                }
            }), i(e, "Extensions/BorderRadius.js", [e["Core/Defaults.js"], e["Core/Globals.js"], e["Core/Utilities.js"]], function (t, e, i) {
                let {defaultOptions: s} = t, {noop: r} = e, {
                    addEvent: o,
                    extend: n,
                    isObject: a,
                    merge: l,
                    relativeLength: h
                } = i, d = {radius: 0, scope: "stack", where: void 0}, c = r, p = r;

                function u(t, e, i, s, r = {}) {
                    let o = c(t, e, i, s, r), {innerR: n = 0, r: a = i, start: l = 0, end: d = 0} = r;
                    if (r.open || !r.borderRadius) return o;
                    let p = d - l, u = Math.sin(p / 2),
                        g = Math.max(Math.min(h(r.borderRadius || 0, a - n), (a - n) / 2, a * u / (1 + u)), 0),
                        f = Math.min(g, p / Math.PI * 2 * n), m = o.length - 1;
                    for (; m--;) !function (t, e, i) {
                        let s, r, o;
                        let n = t[e], a = t[e + 1];
                        if ("Z" === a[0] && (a = t[0]), ("M" === n[0] || "L" === n[0]) && "A" === a[0] ? (s = n, r = a, o = !0) : "A" === n[0] && ("M" === a[0] || "L" === a[0]) && (s = a, r = n), s && r && r.params) {
                            let n = r[1], a = r[5], l = r.params, {start: h, end: d, cx: c, cy: p} = l,
                                u = a ? n - i : n + i, g = u ? Math.asin(i / u) : 0, f = a ? g : -g,
                                m = Math.cos(g) * u;
                ...
                function g() {
                    if (this.options.borderRadius && !(this.chart.is3d && this.chart.is3d())) {
                        let {options: t, yAxis: e} = this, i = "percent" === t.stacking,
                            r = s.plotOptions?.[this.type]?.borderRadius, o = f(t.borderRadius, a(r) ? r : {}),
                            l = e.options.reversed;
                        for (let s of this.points) {
                            let {shapeArgs: r} = s;
                            if ("roundedRect" === s.shapeType && r) {
                                let {width: a = 0, height: d = 0, y: c = 0} = r, p = c, u = d;
                                ...
                                let g = (s.negative ? -1 : 1) * (l ? -1 : 1) == -1, f = o.where;
                                ...
                                "end" === f && (g && (p -= m), u += m), n(r, {brBoxHeight: u, brBoxY: p, r: m})
                            }
                        }
                    }
                }
                ...
                function f(t, e) {
                    return a(t) || (t = {radius: t || 0}), l(d, e, t)
                }
                ...
                function x(t, e, i, s, r = {}) {
                    let o = p(t, e, i, s, r), {r: n = 0, brBoxHeight: a = s, brBoxY: l = e} = r, h = e - l,
                        d = l + a - (e + s), c = h - n > -.1 ? 0 : n, u = d - n > -.1 ? 0 : n, g = Math.max(c && h, 0),
                        f = Math.max(u && d, 0), m = [t + c, e], x = [t + i - c, e], y = [t + i, e + c],
                        b = [t + i, e + s - u], v = [t + i - u, e + s], k = [t + u, e + s], S = [t, e + s - u],
                        C = [t, e + c], M = (t, e) => Math.sqrt(Math.pow(t, 2) - Math.pow(e, 2));
                    if (g) {
                        let t = M(c, c - g);
                ...
                return {
                    compose: function (t, e, i) {
                        ...
                        if (!e.symbolCustomAttribs.includes("borderRadius")) {
                            ...
                            o(t, "afterColumnTranslate", g, {order: 9}), o(s, "afterTranslate", m), e.symbolCustomAttribs.push("borderRadius", "brBoxHeight", "brBoxY"), c = r.arc, p = r.roundedRect, r.arc = u, r.roundedRect = x
                        }
                    }, optionsToObject: f
                }
                ...
                return function (t) {
                    ...
                    function l(t, e) {
                        let s = this.options.responsive, n = this.currentResponsive, l = [], h;
                        ...
                        d.isResponsiveOptions = !0, (l = l.toString() || void 0) === (n && n.ruleIds) || (n && (this.currentResponsive = void 0, this.updatingResponsive = !0, this.update(n.undoOptions, t, !0), this.updatingResponsive = !1), l ? ((h = i(d, this.options, !0, this.collectionsWithUpdate)).isResponsiveOptions = !0, this.currentResponsive = {
                            ruleIds: l,
                            mergedOptions: d,
                            undoOptions: h
...
//# sourceMappingURL=4b358913-3b928db66289b377.js.map